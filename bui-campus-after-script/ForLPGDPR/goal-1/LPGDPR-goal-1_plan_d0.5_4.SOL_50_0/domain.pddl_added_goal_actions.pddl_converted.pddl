...
(:action hidden-explain-obs-occur_move_jones_theater_cbs_2
     :parameters ()
     :precondition (and (considered_occur_move_tav_hayman_theater_1)(occur_move jones_theater cbs))
     :effect (and (not (considered_occur_move_tav_hayman_theater_1)) (considered_occur_move_jones_theater_cbs_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_jones_theater_cbs_2
     :parameters ()
     :precondition (and (considered_occur_move_tav_hayman_theater_1)(not (occur_move jones_theater cbs)))
     :effect (and (not (considered_occur_move_tav_hayman_theater_1)) (considered_occur_move_jones_theater_cbs_2) (increase (total-cost) 2000)))
)
