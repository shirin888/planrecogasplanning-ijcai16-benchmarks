...
(considered_occur_move_library_tav_1)
...
(:action hidden-explain-obs-occur_move_library_tav_1
     :parameters ()
     :precondition (and (considered_occur_move_angazi_cafe_watson_theater_0)(occur_move library tav))
     :effect (and (not (considered_occur_move_angazi_cafe_watson_theater_0)) (considered_occur_move_library_tav_1) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_library_tav_1
     :parameters ()
     :precondition (and (considered_occur_move_angazi_cafe_watson_theater_0)(not (occur_move library tav)))
     :effect (and (not (considered_occur_move_angazi_cafe_watson_theater_0)) (considered_occur_move_library_tav_1) (increase (total-cost) 2000)))
)
