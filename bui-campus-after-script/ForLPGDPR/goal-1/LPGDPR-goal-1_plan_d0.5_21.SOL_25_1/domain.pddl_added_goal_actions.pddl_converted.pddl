...
(:action hidden-explain-obs-occur_move_bank_davis_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_angazi_cafe_bookmark_cafe_1)(occur_move bank davis_theater))
     :effect (and (not (considered_occur_move_angazi_cafe_bookmark_cafe_1)) (considered_occur_move_bank_davis_theater_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_bank_davis_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_angazi_cafe_bookmark_cafe_1)(not (occur_move bank davis_theater)))
     :effect (and (not (considered_occur_move_angazi_cafe_bookmark_cafe_1)) (considered_occur_move_bank_davis_theater_2) (increase (total-cost) 2000)))
)
