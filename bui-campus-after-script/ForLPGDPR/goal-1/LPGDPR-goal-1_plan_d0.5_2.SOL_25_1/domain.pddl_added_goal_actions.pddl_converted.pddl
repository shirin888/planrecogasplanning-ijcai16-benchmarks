...
(:action hidden-explain-obs-occur_move_cbs_psychology_bldg_1
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_bookmark_cafe_0)(occur_move cbs psychology_bldg))
     :effect (and (not (considered_occur_move_hayman_theater_bookmark_cafe_0)) (considered_occur_move_cbs_psychology_bldg_1) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_cbs_psychology_bldg_1
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_bookmark_cafe_0)(not (occur_move cbs psychology_bldg)))
     :effect (and (not (considered_occur_move_hayman_theater_bookmark_cafe_0)) (considered_occur_move_cbs_psychology_bldg_1) (increase (total-cost) 2000)))
)
