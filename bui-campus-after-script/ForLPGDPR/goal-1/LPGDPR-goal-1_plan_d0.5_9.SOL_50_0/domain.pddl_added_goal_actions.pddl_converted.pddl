...
(:action hidden-explain-obs-occur_move_tav_cbs_1
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_tav_0)(occur_move tav cbs))
     :effect (and (not (considered_occur_move_watson_theater_tav_0)) (considered_occur_move_tav_cbs_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_cbs_hayman_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_tav_cbs_1)(occur_move cbs hayman_theater))
     :effect (and (not (considered_occur_move_tav_cbs_1)) (considered_occur_move_cbs_hayman_theater_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_tav_cbs_1
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_tav_0)(not (occur_move tav cbs)))
     :effect (and (not (considered_occur_move_watson_theater_tav_0)) (considered_occur_move_tav_cbs_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_cbs_hayman_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_tav_cbs_1)(not (occur_move cbs hayman_theater)))
     :effect (and (not (considered_occur_move_tav_cbs_1)) (considered_occur_move_cbs_hayman_theater_2) (increase (total-cost) 2000)))
)
