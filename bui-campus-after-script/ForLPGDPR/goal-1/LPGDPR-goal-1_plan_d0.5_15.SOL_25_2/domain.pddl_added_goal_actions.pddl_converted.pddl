...
(:predicates (considered_occur_init)(considered_occur_move_tav_cbs_0)
(considered_occur_move_watson_theater_hayman_theater_1)
(considered_occur_move_watson_theater_cbs_2)
...
(:action hidden-explain-obs-occur_move_tav_cbs_0
     :parameters ()
     :precondition (and  (considered_occur_init) (occur_move tav cbs))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_tav_cbs_0) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_watson_theater_hayman_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_tav_cbs_0)(occur_move watson_theater hayman_theater))
     :effect (and (not (considered_occur_move_tav_cbs_0)) (considered_occur_move_watson_theater_hayman_theater_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_watson_theater_cbs_2
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_hayman_theater_1)(occur_move watson_theater cbs))
     :effect (and (not (considered_occur_move_watson_theater_hayman_theater_1)) (considered_occur_move_watson_theater_cbs_2) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_angazi_cafe_tav_3
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_cbs_2)(occur_move angazi_cafe tav))
     :effect (and (not (considered_occur_move_watson_theater_cbs_2)) (considered_occur_move_angazi_cafe_tav_3) (increase (total-cost) 1)))  



(:action hidden-discard-obs-occur_move_tav_cbs_0
     :parameters ()
     :precondition (and  (considered_occur_init) (not (occur_move tav cbs)))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_tav_cbs_0) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_watson_theater_hayman_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_tav_cbs_0)(not (occur_move watson_theater hayman_theater)))
     :effect (and (not (considered_occur_move_tav_cbs_0)) (considered_occur_move_watson_theater_hayman_theater_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_watson_theater_cbs_2
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_hayman_theater_1)(not (occur_move watson_theater cbs)))
     :effect (and (not (considered_occur_move_watson_theater_hayman_theater_1)) (considered_occur_move_watson_theater_cbs_2) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_angazi_cafe_tav_3
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_cbs_2)(not (occur_move angazi_cafe tav)))
     :effect (and (not (considered_occur_move_watson_theater_cbs_2)) (considered_occur_move_angazi_cafe_tav_3) (increase (total-cost) 2000)))
)
