...
(:predicates (considered_occur_init)(considered_occur_move_angazi_cafe_hayman_theater_0)
...
(:action hidden-explain-obs-occur_move_angazi_cafe_hayman_theater_0
     :parameters ()
     :precondition (and  (considered_occur_init) (occur_move angazi_cafe hayman_theater))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_angazi_cafe_hayman_theater_0) (increase (total-cost) 1)))  



(:action hidden-discard-obs-occur_move_angazi_cafe_hayman_theater_0
     :parameters ()
     :precondition (and  (considered_occur_init) (not (occur_move angazi_cafe hayman_theater)))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_angazi_cafe_hayman_theater_0) (increase (total-cost) 2000)))
)
