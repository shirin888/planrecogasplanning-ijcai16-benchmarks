...
(considered_occur_move_bank_hayman_theater_3)
...
(:action hidden-explain-obs-occur_move_watson_theater_tav_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_0)(occur_move watson_theater tav))
     :effect (and (not (considered_occur_move_davis_theater_bank_0)) (considered_occur_move_watson_theater_tav_1) (increase (total-cost) 1)))  
...
(:action hidden-explain-obs-occur_move_bank_hayman_theater_3
     :parameters ()
     :precondition (and (considered_occur_move_tav_hayman_theater_2)(occur_move bank hayman_theater))
     :effect (and (not (considered_occur_move_tav_hayman_theater_2)) (considered_occur_move_bank_hayman_theater_3) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_watson_theater_tav_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_0)(not (occur_move watson_theater tav)))
     :effect (and (not (considered_occur_move_davis_theater_bank_0)) (considered_occur_move_watson_theater_tav_1) (increase (total-cost) 2000)))
...
(:action hidden-discard-obs-occur_move_bank_hayman_theater_3
     :parameters ()
     :precondition (and (considered_occur_move_tav_hayman_theater_2)(not (occur_move bank hayman_theater)))
     :effect (and (not (considered_occur_move_tav_hayman_theater_2)) (considered_occur_move_bank_hayman_theater_3) (increase (total-cost) 2000)))
)
