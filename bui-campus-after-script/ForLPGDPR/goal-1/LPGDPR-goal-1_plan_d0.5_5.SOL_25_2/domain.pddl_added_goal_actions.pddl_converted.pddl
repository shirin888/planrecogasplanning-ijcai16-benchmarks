...
(:predicates (considered_occur_init)(considered_occur_move_tav_hayman_theater_0)
(considered_occur_move_cbs_angazi_cafe_1)
(considered_occur_move_bank_bookmark_cafe_2)
...
(:action hidden-explain-obs-occur_move_tav_hayman_theater_0
     :parameters ()
     :precondition (and  (considered_occur_init) (occur_move tav hayman_theater))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_tav_hayman_theater_0) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_cbs_angazi_cafe_1
     :parameters ()
     :precondition (and (considered_occur_move_tav_hayman_theater_0)(occur_move cbs angazi_cafe))
     :effect (and (not (considered_occur_move_tav_hayman_theater_0)) (considered_occur_move_cbs_angazi_cafe_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_bank_bookmark_cafe_2
     :parameters ()
     :precondition (and (considered_occur_move_cbs_angazi_cafe_1)(occur_move bank bookmark_cafe))
     :effect (and (not (considered_occur_move_cbs_angazi_cafe_1)) (considered_occur_move_bank_bookmark_cafe_2) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_library_angazi_cafe_3
     :parameters ()
     :precondition (and (considered_occur_move_bank_bookmark_cafe_2)(occur_move library angazi_cafe))
     :effect (and (not (considered_occur_move_bank_bookmark_cafe_2)) (considered_occur_move_library_angazi_cafe_3) (increase (total-cost) 1)))  



(:action hidden-discard-obs-occur_move_tav_hayman_theater_0
     :parameters ()
     :precondition (and  (considered_occur_init) (not (occur_move tav hayman_theater)))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_tav_hayman_theater_0) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_cbs_angazi_cafe_1
     :parameters ()
     :precondition (and (considered_occur_move_tav_hayman_theater_0)(not (occur_move cbs angazi_cafe)))
     :effect (and (not (considered_occur_move_tav_hayman_theater_0)) (considered_occur_move_cbs_angazi_cafe_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_bank_bookmark_cafe_2
     :parameters ()
     :precondition (and (considered_occur_move_cbs_angazi_cafe_1)(not (occur_move bank bookmark_cafe)))
     :effect (and (not (considered_occur_move_cbs_angazi_cafe_1)) (considered_occur_move_bank_bookmark_cafe_2) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_library_angazi_cafe_3
     :parameters ()
     :precondition (and (considered_occur_move_bank_bookmark_cafe_2)(not (occur_move library angazi_cafe)))
     :effect (and (not (considered_occur_move_bank_bookmark_cafe_2)) (considered_occur_move_library_angazi_cafe_3) (increase (total-cost) 2000)))
)
