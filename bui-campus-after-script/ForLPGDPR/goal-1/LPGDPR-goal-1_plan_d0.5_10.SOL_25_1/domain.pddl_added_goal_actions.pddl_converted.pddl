...
(:action hidden-explain-obs-occur_move_bookmark_cafe_psychology_bldg_2
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_hayman_theater_1)(occur_move bookmark_cafe psychology_bldg))
     :effect (and (not (considered_occur_move_watson_theater_hayman_theater_1)) (considered_occur_move_bookmark_cafe_psychology_bldg_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_bookmark_cafe_psychology_bldg_2
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_hayman_theater_1)(not (occur_move bookmark_cafe psychology_bldg)))
     :effect (and (not (considered_occur_move_watson_theater_hayman_theater_1)) (considered_occur_move_bookmark_cafe_psychology_bldg_2) (increase (total-cost) 2000)))
)
