...
(:action hidden-explain-obs-occur_move_cbs_tav_1
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_bookmark_cafe_0)(occur_move cbs tav))
     :effect (and (not (considered_occur_move_watson_theater_bookmark_cafe_0)) (considered_occur_move_cbs_tav_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_angazi_cafe_cbs_2
     :parameters ()
     :precondition (and (considered_occur_move_cbs_tav_1)(occur_move angazi_cafe cbs))
     :effect (and (not (considered_occur_move_cbs_tav_1)) (considered_occur_move_angazi_cafe_cbs_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_cbs_tav_1
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_bookmark_cafe_0)(not (occur_move cbs tav)))
     :effect (and (not (considered_occur_move_watson_theater_bookmark_cafe_0)) (considered_occur_move_cbs_tav_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_angazi_cafe_cbs_2
     :parameters ()
     :precondition (and (considered_occur_move_cbs_tav_1)(not (occur_move angazi_cafe cbs)))
     :effect (and (not (considered_occur_move_cbs_tav_1)) (considered_occur_move_angazi_cafe_cbs_2) (increase (total-cost) 2000)))
)
