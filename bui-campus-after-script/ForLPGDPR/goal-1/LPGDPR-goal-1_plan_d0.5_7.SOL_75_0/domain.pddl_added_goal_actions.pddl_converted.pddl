...
(:action hidden-explain-obs-occur_move_hayman_theater_cbs_2
     :parameters ()
     :precondition (and (considered_occur_move_tav_watson_theater_1)(occur_move hayman_theater cbs))
     :effect (and (not (considered_occur_move_tav_watson_theater_1)) (considered_occur_move_hayman_theater_cbs_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_hayman_theater_cbs_2
     :parameters ()
     :precondition (and (considered_occur_move_tav_watson_theater_1)(not (occur_move hayman_theater cbs)))
     :effect (and (not (considered_occur_move_tav_watson_theater_1)) (considered_occur_move_hayman_theater_cbs_2) (increase (total-cost) 2000)))
