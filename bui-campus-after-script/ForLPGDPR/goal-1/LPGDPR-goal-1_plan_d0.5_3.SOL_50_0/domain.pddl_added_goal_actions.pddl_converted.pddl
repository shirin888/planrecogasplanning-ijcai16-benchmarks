...
(:predicates (considered_occur_init)(considered_occur_move_hayman_theater_angazi_cafe_0)
...
(:action hidden-explain-obs-occur_move_hayman_theater_angazi_cafe_0
     :parameters ()
     :precondition (and  (considered_occur_init) (occur_move hayman_theater angazi_cafe))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_hayman_theater_angazi_cafe_0) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_angazi_cafe_bank_1
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_angazi_cafe_0)(occur_move angazi_cafe bank))
     :effect (and (not (considered_occur_move_hayman_theater_angazi_cafe_0)) (considered_occur_move_angazi_cafe_bank_1) (increase (total-cost) 1)))  
...
(:action hidden-explain-obs-occur_move_library_tav_3
     :parameters ()
     :precondition (and (considered_occur_move_bank_library_2)(occur_move library tav))
     :effect (and (not (considered_occur_move_bank_library_2)) (considered_occur_move_library_tav_3) (increase (total-cost) 1)))  



(:action hidden-discard-obs-occur_move_hayman_theater_angazi_cafe_0
     :parameters ()
     :precondition (and  (considered_occur_init) (not (occur_move hayman_theater angazi_cafe)))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_hayman_theater_angazi_cafe_0) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_angazi_cafe_bank_1
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_angazi_cafe_0)(not (occur_move angazi_cafe bank)))
     :effect (and (not (considered_occur_move_hayman_theater_angazi_cafe_0)) (considered_occur_move_angazi_cafe_bank_1) (increase (total-cost) 2000)))
...
(:action hidden-discard-obs-occur_move_library_tav_3
     :parameters ()
     :precondition (and (considered_occur_move_bank_library_2)(not (occur_move library tav)))
     :effect (and (not (considered_occur_move_bank_library_2)) (considered_occur_move_library_tav_3) (increase (total-cost) 2000)))
)
