...
(:action hidden-explain-obs-occur_move_tav_hayman_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_0)(occur_move tav hayman_theater))
     :effect (and (not (considered_occur_move_davis_theater_bank_0)) (considered_occur_move_tav_hayman_theater_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_hayman_theater_library_2
     :parameters ()
     :precondition (and (considered_occur_move_tav_hayman_theater_1)(occur_move hayman_theater library))
     :effect (and (not (considered_occur_move_tav_hayman_theater_1)) (considered_occur_move_hayman_theater_library_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_tav_hayman_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_0)(not (occur_move tav hayman_theater)))
     :effect (and (not (considered_occur_move_davis_theater_bank_0)) (considered_occur_move_tav_hayman_theater_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_hayman_theater_library_2
     :parameters ()
     :precondition (and (considered_occur_move_tav_hayman_theater_1)(not (occur_move hayman_theater library)))
     :effect (and (not (considered_occur_move_tav_hayman_theater_1)) (considered_occur_move_hayman_theater_library_2) (increase (total-cost) 2000)))
)
