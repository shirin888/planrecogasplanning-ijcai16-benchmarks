...
(:action hidden-explain-obs-occur_move_bookmark_cafe_library_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_watson_theater_0)(occur_move bookmark_cafe library))
     :effect (and (not (considered_occur_move_davis_theater_watson_theater_0)) (considered_occur_move_bookmark_cafe_library_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_hayman_theater_jones_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_library_1)(occur_move hayman_theater jones_theater))
     :effect (and (not (considered_occur_move_bookmark_cafe_library_1)) (considered_occur_move_hayman_theater_jones_theater_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_bookmark_cafe_library_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_watson_theater_0)(not (occur_move bookmark_cafe library)))
     :effect (and (not (considered_occur_move_davis_theater_watson_theater_0)) (considered_occur_move_bookmark_cafe_library_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_hayman_theater_jones_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_library_1)(not (occur_move hayman_theater jones_theater)))
     :effect (and (not (considered_occur_move_bookmark_cafe_library_1)) (considered_occur_move_hayman_theater_jones_theater_2) (increase (total-cost) 2000)))
)
