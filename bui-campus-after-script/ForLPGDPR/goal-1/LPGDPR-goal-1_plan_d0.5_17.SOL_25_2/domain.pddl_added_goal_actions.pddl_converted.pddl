...
(considered_occur_move_bank_angazi_cafe_2)
...
(:action hidden-explain-obs-occur_move_hayman_theater_library_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_tav_0)(occur_move hayman_theater library))
     :effect (and (not (considered_occur_move_davis_theater_tav_0)) (considered_occur_move_hayman_theater_library_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_bank_angazi_cafe_2
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_library_1)(occur_move bank angazi_cafe))
     :effect (and (not (considered_occur_move_hayman_theater_library_1)) (considered_occur_move_bank_angazi_cafe_2) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_davis_theater_watson_theater_3
     :parameters ()
     :precondition (and (considered_occur_move_bank_angazi_cafe_2)(occur_move davis_theater watson_theater))
     :effect (and (not (considered_occur_move_bank_angazi_cafe_2)) (considered_occur_move_davis_theater_watson_theater_3) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_hayman_theater_library_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_tav_0)(not (occur_move hayman_theater library)))
     :effect (and (not (considered_occur_move_davis_theater_tav_0)) (considered_occur_move_hayman_theater_library_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_bank_angazi_cafe_2
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_library_1)(not (occur_move bank angazi_cafe)))
     :effect (and (not (considered_occur_move_hayman_theater_library_1)) (considered_occur_move_bank_angazi_cafe_2) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_davis_theater_watson_theater_3
     :parameters ()
     :precondition (and (considered_occur_move_bank_angazi_cafe_2)(not (occur_move davis_theater watson_theater)))
     :effect (and (not (considered_occur_move_bank_angazi_cafe_2)) (considered_occur_move_davis_theater_watson_theater_3) (increase (total-cost) 2000)))
)
