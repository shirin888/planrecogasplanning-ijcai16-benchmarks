...
(:action hidden-explain-obs-occur_move_hayman_theater_tav_1
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_watson_theater_0)(occur_move hayman_theater tav))
     :effect (and (not (considered_occur_move_bookmark_cafe_watson_theater_0)) (considered_occur_move_hayman_theater_tav_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_cbs_hayman_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_tav_1)(occur_move cbs hayman_theater))
     :effect (and (not (considered_occur_move_hayman_theater_tav_1)) (considered_occur_move_cbs_hayman_theater_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_hayman_theater_tav_1
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_watson_theater_0)(not (occur_move hayman_theater tav)))
     :effect (and (not (considered_occur_move_bookmark_cafe_watson_theater_0)) (considered_occur_move_hayman_theater_tav_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_cbs_hayman_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_tav_1)(not (occur_move cbs hayman_theater)))
     :effect (and (not (considered_occur_move_hayman_theater_tav_1)) (considered_occur_move_cbs_hayman_theater_2) (increase (total-cost) 2000)))
)
