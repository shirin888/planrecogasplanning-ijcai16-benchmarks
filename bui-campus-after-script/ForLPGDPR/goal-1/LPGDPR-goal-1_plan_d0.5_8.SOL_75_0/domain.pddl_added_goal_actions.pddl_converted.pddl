...
(:action hidden-explain-obs-occur_move_hayman_theater_library_3
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_tav_2)(occur_move hayman_theater library))
     :effect (and (not (considered_occur_move_watson_theater_tav_2)) (considered_occur_move_hayman_theater_library_3) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_hayman_theater_library_3
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_tav_2)(not (occur_move hayman_theater library)))
     :effect (and (not (considered_occur_move_watson_theater_tav_2)) (considered_occur_move_hayman_theater_library_3) (increase (total-cost) 2000)))
