...
(:action hidden-explain-obs-occur_move_library_tav_2
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_tav_1)(occur_move library tav))
     :effect (and (not (considered_occur_move_watson_theater_tav_1)) (considered_occur_move_library_tav_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_library_tav_2
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_tav_1)(not (occur_move library tav)))
     :effect (and (not (considered_occur_move_watson_theater_tav_1)) (considered_occur_move_library_tav_2) (increase (total-cost) 2000)))
)
