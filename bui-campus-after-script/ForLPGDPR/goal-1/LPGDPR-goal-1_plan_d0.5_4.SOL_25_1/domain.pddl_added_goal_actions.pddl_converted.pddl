...
(:predicates (considered_occur_init)(considered_occur_move_hayman_theater_jones_theater_0)
(considered_occur_move_jones_theater_cbs_1)
...
(:action hidden-explain-obs-occur_move_hayman_theater_jones_theater_0
     :parameters ()
     :precondition (and  (considered_occur_init) (occur_move hayman_theater jones_theater))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_hayman_theater_jones_theater_0) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_jones_theater_cbs_1
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_jones_theater_0)(occur_move jones_theater cbs))
     :effect (and (not (considered_occur_move_hayman_theater_jones_theater_0)) (considered_occur_move_jones_theater_cbs_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_angazi_cafe_library_2
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_cbs_1)(occur_move angazi_cafe library))
     :effect (and (not (considered_occur_move_jones_theater_cbs_1)) (considered_occur_move_angazi_cafe_library_2) (increase (total-cost) 1)))  



(:action hidden-discard-obs-occur_move_hayman_theater_jones_theater_0
     :parameters ()
     :precondition (and  (considered_occur_init) (not (occur_move hayman_theater jones_theater)))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_hayman_theater_jones_theater_0) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_jones_theater_cbs_1
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_jones_theater_0)(not (occur_move jones_theater cbs)))
     :effect (and (not (considered_occur_move_hayman_theater_jones_theater_0)) (considered_occur_move_jones_theater_cbs_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_angazi_cafe_library_2
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_cbs_1)(not (occur_move angazi_cafe library)))
     :effect (and (not (considered_occur_move_jones_theater_cbs_1)) (considered_occur_move_angazi_cafe_library_2) (increase (total-cost) 2000)))
)
