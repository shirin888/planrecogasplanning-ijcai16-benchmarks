...
(:action hidden-explain-obs-occur_move_davis_theater_bookmark_cafe_2
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_bookmark_cafe_1)(occur_move davis_theater bookmark_cafe))
     :effect (and (not (considered_occur_move_watson_theater_bookmark_cafe_1)) (considered_occur_move_davis_theater_bookmark_cafe_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_davis_theater_bookmark_cafe_2
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_bookmark_cafe_1)(not (occur_move davis_theater bookmark_cafe)))
     :effect (and (not (considered_occur_move_watson_theater_bookmark_cafe_1)) (considered_occur_move_davis_theater_bookmark_cafe_2) (increase (total-cost) 2000)))
)
