...
(:action hidden-explain-obs-occur_move_bookmark_cafe_hayman_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_tav_1)(occur_move bookmark_cafe hayman_theater))
     :effect (and (not (considered_occur_move_watson_theater_tav_1)) (considered_occur_move_bookmark_cafe_hayman_theater_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_bookmark_cafe_hayman_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_tav_1)(not (occur_move bookmark_cafe hayman_theater)))
     :effect (and (not (considered_occur_move_watson_theater_tav_1)) (considered_occur_move_bookmark_cafe_hayman_theater_2) (increase (total-cost) 2000)))
)
