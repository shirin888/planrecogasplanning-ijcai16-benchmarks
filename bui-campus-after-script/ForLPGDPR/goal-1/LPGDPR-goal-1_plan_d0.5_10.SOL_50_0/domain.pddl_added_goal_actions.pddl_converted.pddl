...
(:action hidden-explain-obs-occur_move_hayman_theater_cbs_1
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_watson_theater_0)(occur_move hayman_theater cbs))
     :effect (and (not (considered_occur_move_bookmark_cafe_watson_theater_0)) (considered_occur_move_hayman_theater_cbs_1) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_hayman_theater_cbs_1
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_watson_theater_0)(not (occur_move hayman_theater cbs)))
     :effect (and (not (considered_occur_move_bookmark_cafe_watson_theater_0)) (considered_occur_move_hayman_theater_cbs_1) (increase (total-cost) 2000)))
