...
(:predicates (considered_occur_init)(considered_occur_move_hayman_theater_davis_theater_0)
...
(:action hidden-explain-obs-occur_move_hayman_theater_davis_theater_0
     :parameters ()
     :precondition (and  (considered_occur_init) (occur_move hayman_theater davis_theater))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_hayman_theater_davis_theater_0) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_davis_theater_bookmark_cafe_1
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_davis_theater_0)(occur_move davis_theater bookmark_cafe))
     :effect (and (not (considered_occur_move_hayman_theater_davis_theater_0)) (considered_occur_move_davis_theater_bookmark_cafe_1) (increase (total-cost) 1)))  



(:action hidden-discard-obs-occur_move_hayman_theater_davis_theater_0
     :parameters ()
     :precondition (and  (considered_occur_init) (not (occur_move hayman_theater davis_theater)))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_hayman_theater_davis_theater_0) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_davis_theater_bookmark_cafe_1
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_davis_theater_0)(not (occur_move davis_theater bookmark_cafe)))
     :effect (and (not (considered_occur_move_hayman_theater_davis_theater_0)) (considered_occur_move_davis_theater_bookmark_cafe_1) (increase (total-cost) 2000)))
)
