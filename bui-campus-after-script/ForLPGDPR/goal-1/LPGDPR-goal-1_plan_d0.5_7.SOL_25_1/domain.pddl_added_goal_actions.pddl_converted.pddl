...
(considered_occur_move_hayman_theater_psychology_bldg_2)
...
(:action hidden-explain-obs-occur_move_hayman_theater_psychology_bldg_2
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_cbs_1)(occur_move hayman_theater psychology_bldg))
     :effect (and (not (considered_occur_move_hayman_theater_cbs_1)) (considered_occur_move_hayman_theater_psychology_bldg_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_hayman_theater_psychology_bldg_2
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_cbs_1)(not (occur_move hayman_theater psychology_bldg)))
     :effect (and (not (considered_occur_move_hayman_theater_cbs_1)) (considered_occur_move_hayman_theater_psychology_bldg_2) (increase (total-cost) 2000)))
)
