...
(considered_occur_move_cbs_tav_1)
(considered_occur_move_tav_bank_2)
(considered_occur_move_watson_theater_bank_3)
...
(:action hidden-explain-obs-occur_move_cbs_tav_1
     :parameters ()
     :precondition (and (considered_occur_move_tav_watson_theater_0)(occur_move cbs tav))
     :effect (and (not (considered_occur_move_tav_watson_theater_0)) (considered_occur_move_cbs_tav_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_tav_bank_2
     :parameters ()
     :precondition (and (considered_occur_move_cbs_tav_1)(occur_move tav bank))
     :effect (and (not (considered_occur_move_cbs_tav_1)) (considered_occur_move_tav_bank_2) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_watson_theater_bank_3
     :parameters ()
     :precondition (and (considered_occur_move_tav_bank_2)(occur_move watson_theater bank))
     :effect (and (not (considered_occur_move_tav_bank_2)) (considered_occur_move_watson_theater_bank_3) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_cbs_tav_1
     :parameters ()
     :precondition (and (considered_occur_move_tav_watson_theater_0)(not (occur_move cbs tav)))
     :effect (and (not (considered_occur_move_tav_watson_theater_0)) (considered_occur_move_cbs_tav_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_tav_bank_2
     :parameters ()
     :precondition (and (considered_occur_move_cbs_tav_1)(not (occur_move tav bank)))
     :effect (and (not (considered_occur_move_cbs_tav_1)) (considered_occur_move_tav_bank_2) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_watson_theater_bank_3
     :parameters ()
     :precondition (and (considered_occur_move_tav_bank_2)(not (occur_move watson_theater bank)))
     :effect (and (not (considered_occur_move_tav_bank_2)) (considered_occur_move_watson_theater_bank_3) (increase (total-cost) 2000)))
)
