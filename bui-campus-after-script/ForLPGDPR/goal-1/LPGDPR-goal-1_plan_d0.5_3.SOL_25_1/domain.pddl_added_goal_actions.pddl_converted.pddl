...
(considered_occur_move_tav_watson_theater_2)
...
(:action hidden-explain-obs-occur_move_angazi_cafe_bank_1
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_tav_0)(occur_move angazi_cafe bank))
     :effect (and (not (considered_occur_move_watson_theater_tav_0)) (considered_occur_move_angazi_cafe_bank_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_tav_watson_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_angazi_cafe_bank_1)(occur_move tav watson_theater))
     :effect (and (not (considered_occur_move_angazi_cafe_bank_1)) (considered_occur_move_tav_watson_theater_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_angazi_cafe_bank_1
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_tav_0)(not (occur_move angazi_cafe bank)))
     :effect (and (not (considered_occur_move_watson_theater_tav_0)) (considered_occur_move_angazi_cafe_bank_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_tav_watson_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_angazi_cafe_bank_1)(not (occur_move tav watson_theater)))
     :effect (and (not (considered_occur_move_angazi_cafe_bank_1)) (considered_occur_move_tav_watson_theater_2) (increase (total-cost) 2000)))
)
