...
(:action hidden-explain-obs-occur_move_cbs_bookmark_cafe_1
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_cbs_0)(occur_move cbs bookmark_cafe))
     :effect (and (not (considered_occur_move_hayman_theater_cbs_0)) (considered_occur_move_cbs_bookmark_cafe_1) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_cbs_bookmark_cafe_1
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_cbs_0)(not (occur_move cbs bookmark_cafe)))
     :effect (and (not (considered_occur_move_hayman_theater_cbs_0)) (considered_occur_move_cbs_bookmark_cafe_1) (increase (total-cost) 2000)))
)
