...
(:action hidden-explain-obs-occur_move_psychology_bldg_watson_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_tav_1)(occur_move psychology_bldg watson_theater))
     :effect (and (not (considered_occur_move_watson_theater_tav_1)) (considered_occur_move_psychology_bldg_watson_theater_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_psychology_bldg_watson_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_tav_1)(not (occur_move psychology_bldg watson_theater)))
     :effect (and (not (considered_occur_move_watson_theater_tav_1)) (considered_occur_move_psychology_bldg_watson_theater_2) (increase (total-cost) 2000)))
)
