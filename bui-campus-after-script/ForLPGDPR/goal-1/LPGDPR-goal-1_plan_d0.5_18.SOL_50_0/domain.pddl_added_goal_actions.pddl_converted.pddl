...
(:action hidden-explain-obs-occur_move_bookmark_cafe_tav_2
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_bookmark_cafe_1)(occur_move bookmark_cafe tav))
     :effect (and (not (considered_occur_move_hayman_theater_bookmark_cafe_1)) (considered_occur_move_bookmark_cafe_tav_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_bookmark_cafe_tav_2
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_bookmark_cafe_1)(not (occur_move bookmark_cafe tav)))
     :effect (and (not (considered_occur_move_hayman_theater_bookmark_cafe_1)) (considered_occur_move_bookmark_cafe_tav_2) (increase (total-cost) 2000)))
)
