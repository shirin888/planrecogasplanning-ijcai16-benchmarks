...
(considered_occur_move_cbs_watson_theater_1)
...
(:action hidden-explain-obs-occur_move_cbs_watson_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_bookmark_cafe_0)(occur_move cbs watson_theater))
     :effect (and (not (considered_occur_move_hayman_theater_bookmark_cafe_0)) (considered_occur_move_cbs_watson_theater_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_jones_theater_bank_2
     :parameters ()
     :precondition (and (considered_occur_move_cbs_watson_theater_1)(occur_move jones_theater bank))
     :effect (and (not (considered_occur_move_cbs_watson_theater_1)) (considered_occur_move_jones_theater_bank_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_cbs_watson_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_bookmark_cafe_0)(not (occur_move cbs watson_theater)))
     :effect (and (not (considered_occur_move_hayman_theater_bookmark_cafe_0)) (considered_occur_move_cbs_watson_theater_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_jones_theater_bank_2
     :parameters ()
     :precondition (and (considered_occur_move_cbs_watson_theater_1)(not (occur_move jones_theater bank)))
     :effect (and (not (considered_occur_move_cbs_watson_theater_1)) (considered_occur_move_jones_theater_bank_2) (increase (total-cost) 2000)))
)
