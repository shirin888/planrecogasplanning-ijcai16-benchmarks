...
(considered_occur_move_angazi_cafe_tav_2)
...
(:action hidden-explain-obs-occur_move_angazi_cafe_tav_2
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_hayman_theater_1)(occur_move angazi_cafe tav))
     :effect (and (not (considered_occur_move_bookmark_cafe_hayman_theater_1)) (considered_occur_move_angazi_cafe_tav_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_angazi_cafe_tav_2
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_hayman_theater_1)(not (occur_move angazi_cafe tav)))
     :effect (and (not (considered_occur_move_bookmark_cafe_hayman_theater_1)) (considered_occur_move_angazi_cafe_tav_2) (increase (total-cost) 2000)))
)
