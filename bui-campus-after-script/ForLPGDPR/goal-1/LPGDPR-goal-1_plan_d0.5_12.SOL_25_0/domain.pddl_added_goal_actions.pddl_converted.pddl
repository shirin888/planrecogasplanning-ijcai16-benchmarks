...
(:action hidden-explain-obs-occur_move_watson_theater_hayman_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_bookmark_cafe_0)(occur_move watson_theater hayman_theater))
     :effect (and (not (considered_occur_move_watson_theater_bookmark_cafe_0)) (considered_occur_move_watson_theater_hayman_theater_1) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_watson_theater_hayman_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_bookmark_cafe_0)(not (occur_move watson_theater hayman_theater)))
     :effect (and (not (considered_occur_move_watson_theater_bookmark_cafe_0)) (considered_occur_move_watson_theater_hayman_theater_1) (increase (total-cost) 2000)))
)
