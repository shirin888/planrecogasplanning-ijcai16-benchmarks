...
(considered_occur_move_library_jones_theater_4)
...
(:action hidden-explain-obs-occur_move_davis_theater_jones_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_0)(occur_move davis_theater jones_theater))
     :effect (and (not (considered_occur_move_davis_theater_bank_0)) (considered_occur_move_davis_theater_jones_theater_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_tav_psychology_bldg_2
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_jones_theater_1)(occur_move tav psychology_bldg))
     :effect (and (not (considered_occur_move_davis_theater_jones_theater_1)) (considered_occur_move_tav_psychology_bldg_2) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_library_bookmark_cafe_3
     :parameters ()
     :precondition (and (considered_occur_move_tav_psychology_bldg_2)(occur_move library bookmark_cafe))
     :effect (and (not (considered_occur_move_tav_psychology_bldg_2)) (considered_occur_move_library_bookmark_cafe_3) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_library_jones_theater_4
     :parameters ()
     :precondition (and (considered_occur_move_library_bookmark_cafe_3)(occur_move library jones_theater))
     :effect (and (not (considered_occur_move_library_bookmark_cafe_3)) (considered_occur_move_library_jones_theater_4) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_davis_theater_jones_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_0)(not (occur_move davis_theater jones_theater)))
     :effect (and (not (considered_occur_move_davis_theater_bank_0)) (considered_occur_move_davis_theater_jones_theater_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_tav_psychology_bldg_2
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_jones_theater_1)(not (occur_move tav psychology_bldg)))
     :effect (and (not (considered_occur_move_davis_theater_jones_theater_1)) (considered_occur_move_tav_psychology_bldg_2) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_library_bookmark_cafe_3
     :parameters ()
     :precondition (and (considered_occur_move_tav_psychology_bldg_2)(not (occur_move library bookmark_cafe)))
     :effect (and (not (considered_occur_move_tav_psychology_bldg_2)) (considered_occur_move_library_bookmark_cafe_3) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_library_jones_theater_4
     :parameters ()
     :precondition (and (considered_occur_move_library_bookmark_cafe_3)(not (occur_move library jones_theater)))
     :effect (and (not (considered_occur_move_library_bookmark_cafe_3)) (considered_occur_move_library_jones_theater_4) (increase (total-cost) 2000)))
)
