...
(:action hidden-explain-obs-occur_move_bookmark_cafe_davis_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_bank_cbs_1)(occur_move bookmark_cafe davis_theater))
     :effect (and (not (considered_occur_move_bank_cbs_1)) (considered_occur_move_bookmark_cafe_davis_theater_2) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_watson_theater_psychology_bldg_3
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_davis_theater_2)(occur_move watson_theater psychology_bldg))
     :effect (and (not (considered_occur_move_bookmark_cafe_davis_theater_2)) (considered_occur_move_watson_theater_psychology_bldg_3) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_cbs_jones_theater_4
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_psychology_bldg_3)(occur_move cbs jones_theater))
     :effect (and (not (considered_occur_move_watson_theater_psychology_bldg_3)) (considered_occur_move_cbs_jones_theater_4) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_bookmark_cafe_davis_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_bank_cbs_1)(not (occur_move bookmark_cafe davis_theater)))
     :effect (and (not (considered_occur_move_bank_cbs_1)) (considered_occur_move_bookmark_cafe_davis_theater_2) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_watson_theater_psychology_bldg_3
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_davis_theater_2)(not (occur_move watson_theater psychology_bldg)))
     :effect (and (not (considered_occur_move_bookmark_cafe_davis_theater_2)) (considered_occur_move_watson_theater_psychology_bldg_3) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_cbs_jones_theater_4
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_psychology_bldg_3)(not (occur_move cbs jones_theater)))
     :effect (and (not (considered_occur_move_watson_theater_psychology_bldg_3)) (considered_occur_move_cbs_jones_theater_4) (increase (total-cost) 2000)))
)
