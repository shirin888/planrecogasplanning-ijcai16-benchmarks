...
(considered_occur_move_jones_theater_library_1)
...
(:action hidden-explain-obs-occur_move_jones_theater_library_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_jones_theater_0)(occur_move jones_theater library))
     :effect (and (not (considered_occur_move_davis_theater_jones_theater_0)) (considered_occur_move_jones_theater_library_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_psychology_bldg_bookmark_cafe_2
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_library_1)(occur_move psychology_bldg bookmark_cafe))
     :effect (and (not (considered_occur_move_jones_theater_library_1)) (considered_occur_move_psychology_bldg_bookmark_cafe_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_jones_theater_library_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_jones_theater_0)(not (occur_move jones_theater library)))
     :effect (and (not (considered_occur_move_davis_theater_jones_theater_0)) (considered_occur_move_jones_theater_library_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_psychology_bldg_bookmark_cafe_2
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_library_1)(not (occur_move psychology_bldg bookmark_cafe)))
     :effect (and (not (considered_occur_move_jones_theater_library_1)) (considered_occur_move_psychology_bldg_bookmark_cafe_2) (increase (total-cost) 2000)))
)
