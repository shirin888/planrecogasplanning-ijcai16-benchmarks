...
(considered_occur_move_davis_theater_cbs_1)
...
(:action hidden-explain-obs-occur_move_davis_theater_cbs_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_0)(occur_move davis_theater cbs))
     :effect (and (not (considered_occur_move_davis_theater_bank_0)) (considered_occur_move_davis_theater_cbs_1) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_davis_theater_cbs_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_0)(not (occur_move davis_theater cbs)))
     :effect (and (not (considered_occur_move_davis_theater_bank_0)) (considered_occur_move_davis_theater_cbs_1) (increase (total-cost) 2000)))
)
