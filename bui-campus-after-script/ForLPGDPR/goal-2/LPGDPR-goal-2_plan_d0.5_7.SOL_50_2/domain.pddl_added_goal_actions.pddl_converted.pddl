...
(considered_occur_move_hayman_theater_hayman_theater_4)
(considered_occur_move_tav_hayman_theater_5)
...
(:action hidden-explain-obs-occur_move_hayman_theater_hayman_theater_4
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_jones_theater_3)(occur_move hayman_theater hayman_theater))
     :effect (and (not (considered_occur_move_davis_theater_jones_theater_3)) (considered_occur_move_hayman_theater_hayman_theater_4) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_tav_hayman_theater_5
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_hayman_theater_4)(occur_move tav hayman_theater))
     :effect (and (not (considered_occur_move_hayman_theater_hayman_theater_4)) (considered_occur_move_tav_hayman_theater_5) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_hayman_theater_hayman_theater_4
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_jones_theater_3)(not (occur_move hayman_theater hayman_theater)))
     :effect (and (not (considered_occur_move_davis_theater_jones_theater_3)) (considered_occur_move_hayman_theater_hayman_theater_4) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_tav_hayman_theater_5
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_hayman_theater_4)(not (occur_move tav hayman_theater)))
     :effect (and (not (considered_occur_move_hayman_theater_hayman_theater_4)) (considered_occur_move_tav_hayman_theater_5) (increase (total-cost) 2000)))
)
