...
(considered_occur_move_angazi_cafe_angazi_cafe_3)
...
(:action hidden-explain-obs-occur_move_davis_theater_jones_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_library_davis_theater_1)(occur_move davis_theater jones_theater))
     :effect (and (not (considered_occur_move_library_davis_theater_1)) (considered_occur_move_davis_theater_jones_theater_2) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_angazi_cafe_angazi_cafe_3
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_jones_theater_2)(occur_move angazi_cafe angazi_cafe))
     :effect (and (not (considered_occur_move_davis_theater_jones_theater_2)) (considered_occur_move_angazi_cafe_angazi_cafe_3) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_davis_theater_jones_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_library_davis_theater_1)(not (occur_move davis_theater jones_theater)))
     :effect (and (not (considered_occur_move_library_davis_theater_1)) (considered_occur_move_davis_theater_jones_theater_2) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_angazi_cafe_angazi_cafe_3
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_jones_theater_2)(not (occur_move angazi_cafe angazi_cafe)))
     :effect (and (not (considered_occur_move_davis_theater_jones_theater_2)) (considered_occur_move_angazi_cafe_angazi_cafe_3) (increase (total-cost) 2000)))
)
