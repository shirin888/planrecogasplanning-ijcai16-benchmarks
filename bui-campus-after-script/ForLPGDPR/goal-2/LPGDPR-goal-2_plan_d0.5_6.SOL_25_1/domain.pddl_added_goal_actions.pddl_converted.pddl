...
(:action hidden-explain-obs-occur_move_angazi_cafe_bookmark_cafe_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_0)(occur_move angazi_cafe bookmark_cafe))
     :effect (and (not (considered_occur_move_davis_theater_bank_0)) (considered_occur_move_angazi_cafe_bookmark_cafe_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_bank_cbs_2
     :parameters ()
     :precondition (and (considered_occur_move_angazi_cafe_bookmark_cafe_1)(occur_move bank cbs))
     :effect (and (not (considered_occur_move_angazi_cafe_bookmark_cafe_1)) (considered_occur_move_bank_cbs_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_angazi_cafe_bookmark_cafe_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_0)(not (occur_move angazi_cafe bookmark_cafe)))
     :effect (and (not (considered_occur_move_davis_theater_bank_0)) (considered_occur_move_angazi_cafe_bookmark_cafe_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_bank_cbs_2
     :parameters ()
     :precondition (and (considered_occur_move_angazi_cafe_bookmark_cafe_1)(not (occur_move bank cbs)))
     :effect (and (not (considered_occur_move_angazi_cafe_bookmark_cafe_1)) (considered_occur_move_bank_cbs_2) (increase (total-cost) 2000)))
)
