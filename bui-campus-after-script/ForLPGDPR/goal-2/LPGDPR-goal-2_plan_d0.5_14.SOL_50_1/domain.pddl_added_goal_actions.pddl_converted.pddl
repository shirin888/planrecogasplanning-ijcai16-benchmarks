...
(:action hidden-explain-obs-occur_move_jones_theater_davis_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_0)(occur_move jones_theater davis_theater))
     :effect (and (not (considered_occur_move_davis_theater_bank_0)) (considered_occur_move_jones_theater_davis_theater_1) (increase (total-cost) 1)))  
...
(:action hidden-explain-obs-occur_move_angazi_cafe_bank_4
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_jones_theater_3)(occur_move angazi_cafe bank))
     :effect (and (not (considered_occur_move_bookmark_cafe_jones_theater_3)) (considered_occur_move_angazi_cafe_bank_4) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_jones_theater_davis_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_0)(not (occur_move jones_theater davis_theater)))
     :effect (and (not (considered_occur_move_davis_theater_bank_0)) (considered_occur_move_jones_theater_davis_theater_1) (increase (total-cost) 2000)))
...
(:action hidden-discard-obs-occur_move_angazi_cafe_bank_4
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_jones_theater_3)(not (occur_move angazi_cafe bank)))
     :effect (and (not (considered_occur_move_bookmark_cafe_jones_theater_3)) (considered_occur_move_angazi_cafe_bank_4) (increase (total-cost) 2000)))
)
