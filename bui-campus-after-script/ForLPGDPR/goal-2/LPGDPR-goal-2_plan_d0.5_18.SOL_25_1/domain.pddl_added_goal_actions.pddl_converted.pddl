...
(considered_occur_move_davis_theater_bank_1)
(considered_occur_move_cbs_psychology_bldg_2)
(considered_occur_move_angazi_cafe_library_3)
...
(:action hidden-explain-obs-occur_move_davis_theater_bank_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_0)(occur_move davis_theater bank))
     :effect (and (not (considered_occur_move_davis_theater_bank_0)) (considered_occur_move_davis_theater_bank_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_cbs_psychology_bldg_2
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_1)(occur_move cbs psychology_bldg))
     :effect (and (not (considered_occur_move_davis_theater_bank_1)) (considered_occur_move_cbs_psychology_bldg_2) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_angazi_cafe_library_3
     :parameters ()
     :precondition (and (considered_occur_move_cbs_psychology_bldg_2)(occur_move angazi_cafe library))
     :effect (and (not (considered_occur_move_cbs_psychology_bldg_2)) (considered_occur_move_angazi_cafe_library_3) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_davis_theater_bank_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_0)(not (occur_move davis_theater bank)))
     :effect (and (not (considered_occur_move_davis_theater_bank_0)) (considered_occur_move_davis_theater_bank_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_cbs_psychology_bldg_2
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_1)(not (occur_move cbs psychology_bldg)))
     :effect (and (not (considered_occur_move_davis_theater_bank_1)) (considered_occur_move_cbs_psychology_bldg_2) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_angazi_cafe_library_3
     :parameters ()
     :precondition (and (considered_occur_move_cbs_psychology_bldg_2)(not (occur_move angazi_cafe library)))
     :effect (and (not (considered_occur_move_cbs_psychology_bldg_2)) (considered_occur_move_angazi_cafe_library_3) (increase (total-cost) 2000)))
)
