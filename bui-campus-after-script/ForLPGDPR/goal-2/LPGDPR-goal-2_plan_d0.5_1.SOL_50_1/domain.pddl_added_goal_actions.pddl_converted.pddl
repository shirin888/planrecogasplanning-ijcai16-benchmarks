...
(considered_occur_move_angazi_cafe_tav_3)
...
(:action hidden-explain-obs-occur_move_angazi_cafe_tav_3
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_angazi_cafe_2)(occur_move angazi_cafe tav))
     :effect (and (not (considered_occur_move_davis_theater_angazi_cafe_2)) (considered_occur_move_angazi_cafe_tav_3) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_watson_theater_cbs_4
     :parameters ()
     :precondition (and (considered_occur_move_angazi_cafe_tav_3)(occur_move watson_theater cbs))
     :effect (and (not (considered_occur_move_angazi_cafe_tav_3)) (considered_occur_move_watson_theater_cbs_4) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_angazi_cafe_tav_3
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_angazi_cafe_2)(not (occur_move angazi_cafe tav)))
     :effect (and (not (considered_occur_move_davis_theater_angazi_cafe_2)) (considered_occur_move_angazi_cafe_tav_3) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_watson_theater_cbs_4
     :parameters ()
     :precondition (and (considered_occur_move_angazi_cafe_tav_3)(not (occur_move watson_theater cbs)))
     :effect (and (not (considered_occur_move_angazi_cafe_tav_3)) (considered_occur_move_watson_theater_cbs_4) (increase (total-cost) 2000)))
)
