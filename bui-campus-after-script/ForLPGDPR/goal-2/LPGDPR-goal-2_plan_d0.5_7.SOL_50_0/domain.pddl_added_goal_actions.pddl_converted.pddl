...
(considered_occur_move_hayman_theater_psychology_bldg_3)
...
(:action hidden-explain-obs-occur_move_davis_theater_jones_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_psychology_bldg_davis_theater_1)(occur_move davis_theater jones_theater))
     :effect (and (not (considered_occur_move_psychology_bldg_davis_theater_1)) (considered_occur_move_davis_theater_jones_theater_2) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_hayman_theater_psychology_bldg_3
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_jones_theater_2)(occur_move hayman_theater psychology_bldg))
     :effect (and (not (considered_occur_move_davis_theater_jones_theater_2)) (considered_occur_move_hayman_theater_psychology_bldg_3) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_davis_theater_jones_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_psychology_bldg_davis_theater_1)(not (occur_move davis_theater jones_theater)))
     :effect (and (not (considered_occur_move_psychology_bldg_davis_theater_1)) (considered_occur_move_davis_theater_jones_theater_2) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_hayman_theater_psychology_bldg_3
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_jones_theater_2)(not (occur_move hayman_theater psychology_bldg)))
     :effect (and (not (considered_occur_move_davis_theater_jones_theater_2)) (considered_occur_move_hayman_theater_psychology_bldg_3) (increase (total-cost) 2000)))
)
