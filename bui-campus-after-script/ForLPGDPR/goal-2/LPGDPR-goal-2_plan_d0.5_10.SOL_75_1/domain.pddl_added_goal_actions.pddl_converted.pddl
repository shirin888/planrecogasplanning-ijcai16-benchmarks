...
(:action hidden-explain-obs-occur_move_davis_theater_davis_theater_6
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_bookmark_cafe_5)(occur_move davis_theater davis_theater))
     :effect (and (not (considered_occur_move_jones_theater_bookmark_cafe_5)) (considered_occur_move_davis_theater_davis_theater_6) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_davis_theater_davis_theater_6
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_bookmark_cafe_5)(not (occur_move davis_theater davis_theater)))
     :effect (and (not (considered_occur_move_jones_theater_bookmark_cafe_5)) (considered_occur_move_davis_theater_davis_theater_6) (increase (total-cost) 2000)))
)
