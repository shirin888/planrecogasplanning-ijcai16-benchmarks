...
(considered_occur_move_watson_theater_jones_theater_2)
...
(:action hidden-explain-obs-occur_move_psychology_bldg_davis_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_0)(occur_move psychology_bldg davis_theater))
     :effect (and (not (considered_occur_move_davis_theater_bank_0)) (considered_occur_move_psychology_bldg_davis_theater_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_watson_theater_jones_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_psychology_bldg_davis_theater_1)(occur_move watson_theater jones_theater))
     :effect (and (not (considered_occur_move_psychology_bldg_davis_theater_1)) (considered_occur_move_watson_theater_jones_theater_2) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_jones_theater_bookmark_cafe_3
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_jones_theater_2)(occur_move jones_theater bookmark_cafe))
     :effect (and (not (considered_occur_move_watson_theater_jones_theater_2)) (considered_occur_move_jones_theater_bookmark_cafe_3) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_watson_theater_hayman_theater_4
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_bookmark_cafe_3)(occur_move watson_theater hayman_theater))
     :effect (and (not (considered_occur_move_jones_theater_bookmark_cafe_3)) (considered_occur_move_watson_theater_hayman_theater_4) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_psychology_bldg_davis_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_0)(not (occur_move psychology_bldg davis_theater)))
     :effect (and (not (considered_occur_move_davis_theater_bank_0)) (considered_occur_move_psychology_bldg_davis_theater_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_watson_theater_jones_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_psychology_bldg_davis_theater_1)(not (occur_move watson_theater jones_theater)))
     :effect (and (not (considered_occur_move_psychology_bldg_davis_theater_1)) (considered_occur_move_watson_theater_jones_theater_2) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_jones_theater_bookmark_cafe_3
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_jones_theater_2)(not (occur_move jones_theater bookmark_cafe)))
     :effect (and (not (considered_occur_move_watson_theater_jones_theater_2)) (considered_occur_move_jones_theater_bookmark_cafe_3) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_watson_theater_hayman_theater_4
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_bookmark_cafe_3)(not (occur_move watson_theater hayman_theater)))
     :effect (and (not (considered_occur_move_jones_theater_bookmark_cafe_3)) (considered_occur_move_watson_theater_hayman_theater_4) (increase (total-cost) 2000)))
)
