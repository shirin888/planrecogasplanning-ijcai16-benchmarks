...
(:predicates (considered_occur_init)(considered_occur_move_tav_psychology_bldg_0)
(considered_occur_move_jones_theater_hayman_theater_1)
...
(:action hidden-explain-obs-occur_move_tav_psychology_bldg_0
     :parameters ()
     :precondition (and  (considered_occur_init) (occur_move tav psychology_bldg))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_tav_psychology_bldg_0) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_jones_theater_hayman_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_tav_psychology_bldg_0)(occur_move jones_theater hayman_theater))
     :effect (and (not (considered_occur_move_tav_psychology_bldg_0)) (considered_occur_move_jones_theater_hayman_theater_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_davis_theater_bookmark_cafe_2
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_hayman_theater_1)(occur_move davis_theater bookmark_cafe))
     :effect (and (not (considered_occur_move_jones_theater_hayman_theater_1)) (considered_occur_move_davis_theater_bookmark_cafe_2) (increase (total-cost) 1)))  



(:action hidden-discard-obs-occur_move_tav_psychology_bldg_0
     :parameters ()
     :precondition (and  (considered_occur_init) (not (occur_move tav psychology_bldg)))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_tav_psychology_bldg_0) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_jones_theater_hayman_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_tav_psychology_bldg_0)(not (occur_move jones_theater hayman_theater)))
     :effect (and (not (considered_occur_move_tav_psychology_bldg_0)) (considered_occur_move_jones_theater_hayman_theater_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_davis_theater_bookmark_cafe_2
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_hayman_theater_1)(not (occur_move davis_theater bookmark_cafe)))
     :effect (and (not (considered_occur_move_jones_theater_hayman_theater_1)) (considered_occur_move_davis_theater_bookmark_cafe_2) (increase (total-cost) 2000)))
)
