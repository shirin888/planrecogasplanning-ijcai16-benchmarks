...
(:predicates (considered_occur_init)(considered_occur_move_jones_theater_tav_0)
...
(:action hidden-explain-obs-occur_move_jones_theater_tav_0
     :parameters ()
     :precondition (and  (considered_occur_init) (occur_move jones_theater tav))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_jones_theater_tav_0) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_tav_psychology_bldg_1
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_tav_0)(occur_move tav psychology_bldg))
     :effect (and (not (considered_occur_move_jones_theater_tav_0)) (considered_occur_move_tav_psychology_bldg_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_angazi_cafe_tav_2
     :parameters ()
     :precondition (and (considered_occur_move_tav_psychology_bldg_1)(occur_move angazi_cafe tav))
     :effect (and (not (considered_occur_move_tav_psychology_bldg_1)) (considered_occur_move_angazi_cafe_tav_2) (increase (total-cost) 1)))  



(:action hidden-discard-obs-occur_move_jones_theater_tav_0
     :parameters ()
     :precondition (and  (considered_occur_init) (not (occur_move jones_theater tav)))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_jones_theater_tav_0) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_tav_psychology_bldg_1
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_tav_0)(not (occur_move tav psychology_bldg)))
     :effect (and (not (considered_occur_move_jones_theater_tav_0)) (considered_occur_move_tav_psychology_bldg_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_angazi_cafe_tav_2
     :parameters ()
     :precondition (and (considered_occur_move_tav_psychology_bldg_1)(not (occur_move angazi_cafe tav)))
     :effect (and (not (considered_occur_move_tav_psychology_bldg_1)) (considered_occur_move_angazi_cafe_tav_2) (increase (total-cost) 2000)))
)
