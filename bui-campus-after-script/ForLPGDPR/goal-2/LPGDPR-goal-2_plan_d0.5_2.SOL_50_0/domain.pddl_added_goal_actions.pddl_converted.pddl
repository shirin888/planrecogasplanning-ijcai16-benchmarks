...
(:action hidden-explain-obs-occur_move_tav_psychology_bldg_2
     :parameters ()
     :precondition (and (considered_occur_move_library_davis_theater_1)(occur_move tav psychology_bldg))
     :effect (and (not (considered_occur_move_library_davis_theater_1)) (considered_occur_move_tav_psychology_bldg_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_tav_psychology_bldg_2
     :parameters ()
     :precondition (and (considered_occur_move_library_davis_theater_1)(not (occur_move tav psychology_bldg)))
     :effect (and (not (considered_occur_move_library_davis_theater_1)) (considered_occur_move_tav_psychology_bldg_2) (increase (total-cost) 2000)))
)
