...
(:action hidden-explain-obs-occur_move_davis_theater_jones_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_bank_davis_theater_0)(occur_move davis_theater jones_theater))
     :effect (and (not (considered_occur_move_bank_davis_theater_0)) (considered_occur_move_davis_theater_jones_theater_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_hayman_theater_watson_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_jones_theater_1)(occur_move hayman_theater watson_theater))
     :effect (and (not (considered_occur_move_davis_theater_jones_theater_1)) (considered_occur_move_hayman_theater_watson_theater_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_davis_theater_jones_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_bank_davis_theater_0)(not (occur_move davis_theater jones_theater)))
     :effect (and (not (considered_occur_move_bank_davis_theater_0)) (considered_occur_move_davis_theater_jones_theater_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_hayman_theater_watson_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_jones_theater_1)(not (occur_move hayman_theater watson_theater)))
     :effect (and (not (considered_occur_move_davis_theater_jones_theater_1)) (considered_occur_move_hayman_theater_watson_theater_2) (increase (total-cost) 2000)))
)
