...
(:action hidden-explain-obs-occur_move_tav_library_2
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_psychology_bldg_1)(occur_move tav library))
     :effect (and (not (considered_occur_move_jones_theater_psychology_bldg_1)) (considered_occur_move_tav_library_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_tav_library_2
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_psychology_bldg_1)(not (occur_move tav library)))
     :effect (and (not (considered_occur_move_jones_theater_psychology_bldg_1)) (considered_occur_move_tav_library_2) (increase (total-cost) 2000)))
)
