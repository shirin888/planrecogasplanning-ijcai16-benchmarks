...
(considered_occur_move_jones_theater_angazi_cafe_3)
...
(:action hidden-explain-obs-occur_move_jones_theater_angazi_cafe_3
     :parameters ()
     :precondition (and (considered_occur_move_psychology_bldg_davis_theater_2)(occur_move jones_theater angazi_cafe))
     :effect (and (not (considered_occur_move_psychology_bldg_davis_theater_2)) (considered_occur_move_jones_theater_angazi_cafe_3) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_angazi_cafe_bookmark_cafe_4
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_angazi_cafe_3)(occur_move angazi_cafe bookmark_cafe))
     :effect (and (not (considered_occur_move_jones_theater_angazi_cafe_3)) (considered_occur_move_angazi_cafe_bookmark_cafe_4) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_jones_theater_library_5
     :parameters ()
     :precondition (and (considered_occur_move_angazi_cafe_bookmark_cafe_4)(occur_move jones_theater library))
     :effect (and (not (considered_occur_move_angazi_cafe_bookmark_cafe_4)) (considered_occur_move_jones_theater_library_5) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_psychology_bldg_jones_theater_6
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_library_5)(occur_move psychology_bldg jones_theater))
     :effect (and (not (considered_occur_move_jones_theater_library_5)) (considered_occur_move_psychology_bldg_jones_theater_6) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_jones_theater_angazi_cafe_3
     :parameters ()
     :precondition (and (considered_occur_move_psychology_bldg_davis_theater_2)(not (occur_move jones_theater angazi_cafe)))
     :effect (and (not (considered_occur_move_psychology_bldg_davis_theater_2)) (considered_occur_move_jones_theater_angazi_cafe_3) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_angazi_cafe_bookmark_cafe_4
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_angazi_cafe_3)(not (occur_move angazi_cafe bookmark_cafe)))
     :effect (and (not (considered_occur_move_jones_theater_angazi_cafe_3)) (considered_occur_move_angazi_cafe_bookmark_cafe_4) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_jones_theater_library_5
     :parameters ()
     :precondition (and (considered_occur_move_angazi_cafe_bookmark_cafe_4)(not (occur_move jones_theater library)))
     :effect (and (not (considered_occur_move_angazi_cafe_bookmark_cafe_4)) (considered_occur_move_jones_theater_library_5) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_psychology_bldg_jones_theater_6
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_library_5)(not (occur_move psychology_bldg jones_theater)))
     :effect (and (not (considered_occur_move_jones_theater_library_5)) (considered_occur_move_psychology_bldg_jones_theater_6) (increase (total-cost) 2000)))
)
