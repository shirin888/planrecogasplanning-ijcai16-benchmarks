...
(:action hidden-explain-obs-occur_move_tav_bank_2
     :parameters ()
     :precondition (and (considered_occur_move_bank_psychology_bldg_1)(occur_move tav bank))
     :effect (and (not (considered_occur_move_bank_psychology_bldg_1)) (considered_occur_move_tav_bank_2) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_library_library_3
     :parameters ()
     :precondition (and (considered_occur_move_tav_bank_2)(occur_move library library))
     :effect (and (not (considered_occur_move_tav_bank_2)) (considered_occur_move_library_library_3) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_tav_bank_2
     :parameters ()
     :precondition (and (considered_occur_move_bank_psychology_bldg_1)(not (occur_move tav bank)))
     :effect (and (not (considered_occur_move_bank_psychology_bldg_1)) (considered_occur_move_tav_bank_2) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_library_library_3
     :parameters ()
     :precondition (and (considered_occur_move_tav_bank_2)(not (occur_move library library)))
     :effect (and (not (considered_occur_move_tav_bank_2)) (considered_occur_move_library_library_3) (increase (total-cost) 2000)))
)
