...
(considered_occur_move_tav_tav_2)
...
(:action hidden-explain-obs-occur_move_tav_tav_2
     :parameters ()
     :precondition (and (considered_occur_move_bank_cbs_1)(occur_move tav tav))
     :effect (and (not (considered_occur_move_bank_cbs_1)) (considered_occur_move_tav_tav_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_tav_tav_2
     :parameters ()
     :precondition (and (considered_occur_move_bank_cbs_1)(not (occur_move tav tav)))
     :effect (and (not (considered_occur_move_bank_cbs_1)) (considered_occur_move_tav_tav_2) (increase (total-cost) 2000)))
)
