...
(:action hidden-explain-obs-occur_move_tav_jones_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_bank_cbs_0)(occur_move tav jones_theater))
     :effect (and (not (considered_occur_move_bank_cbs_0)) (considered_occur_move_tav_jones_theater_1) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_tav_jones_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_bank_cbs_0)(not (occur_move tav jones_theater)))
     :effect (and (not (considered_occur_move_bank_cbs_0)) (considered_occur_move_tav_jones_theater_1) (increase (total-cost) 2000)))
