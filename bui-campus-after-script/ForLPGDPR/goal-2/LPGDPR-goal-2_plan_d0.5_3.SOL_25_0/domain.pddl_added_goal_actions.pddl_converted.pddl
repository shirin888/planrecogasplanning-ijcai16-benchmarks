...
(:action hidden-explain-obs-occur_move_bookmark_cafe_jones_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_psychology_bldg_0)(occur_move bookmark_cafe jones_theater))
     :effect (and (not (considered_occur_move_davis_theater_psychology_bldg_0)) (considered_occur_move_bookmark_cafe_jones_theater_1) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_bookmark_cafe_jones_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_psychology_bldg_0)(not (occur_move bookmark_cafe jones_theater)))
     :effect (and (not (considered_occur_move_davis_theater_psychology_bldg_0)) (considered_occur_move_bookmark_cafe_jones_theater_1) (increase (total-cost) 2000)))
)
