...
(:action hidden-explain-obs-occur_move_cbs_jones_theater_3
     :parameters ()
     :precondition (and (considered_occur_move_cbs_davis_theater_2)(occur_move cbs jones_theater))
     :effect (and (not (considered_occur_move_cbs_davis_theater_2)) (considered_occur_move_cbs_jones_theater_3) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_cbs_jones_theater_3
     :parameters ()
     :precondition (and (considered_occur_move_cbs_davis_theater_2)(not (occur_move cbs jones_theater)))
     :effect (and (not (considered_occur_move_cbs_davis_theater_2)) (considered_occur_move_cbs_jones_theater_3) (increase (total-cost) 2000)))
