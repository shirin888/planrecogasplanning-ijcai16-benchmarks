...
(considered_occur_move_watson_theater_bank_7)
...
(:action hidden-explain-obs-occur_move_tav_jones_theater_6
     :parameters ()
     :precondition (and (considered_occur_move_angazi_cafe_bookmark_cafe_5)(occur_move tav jones_theater))
     :effect (and (not (considered_occur_move_angazi_cafe_bookmark_cafe_5)) (considered_occur_move_tav_jones_theater_6) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_watson_theater_bank_7
     :parameters ()
     :precondition (and (considered_occur_move_tav_jones_theater_6)(occur_move watson_theater bank))
     :effect (and (not (considered_occur_move_tav_jones_theater_6)) (considered_occur_move_watson_theater_bank_7) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_tav_jones_theater_6
     :parameters ()
     :precondition (and (considered_occur_move_angazi_cafe_bookmark_cafe_5)(not (occur_move tav jones_theater)))
     :effect (and (not (considered_occur_move_angazi_cafe_bookmark_cafe_5)) (considered_occur_move_tav_jones_theater_6) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_watson_theater_bank_7
     :parameters ()
     :precondition (and (considered_occur_move_tav_jones_theater_6)(not (occur_move watson_theater bank)))
     :effect (and (not (considered_occur_move_tav_jones_theater_6)) (considered_occur_move_watson_theater_bank_7) (increase (total-cost) 2000)))
)
