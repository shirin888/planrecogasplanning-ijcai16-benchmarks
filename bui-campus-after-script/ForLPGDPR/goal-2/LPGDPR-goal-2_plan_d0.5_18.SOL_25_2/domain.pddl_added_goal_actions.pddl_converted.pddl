...
(considered_occur_move_bank_tav_3)
(considered_occur_move_angazi_cafe_angazi_cafe_4)
...
(:action hidden-explain-obs-occur_move_cbs_psychology_bldg_2
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_cbs_1)(occur_move cbs psychology_bldg))
     :effect (and (not (considered_occur_move_hayman_theater_cbs_1)) (considered_occur_move_cbs_psychology_bldg_2) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_bank_tav_3
     :parameters ()
     :precondition (and (considered_occur_move_cbs_psychology_bldg_2)(occur_move bank tav))
     :effect (and (not (considered_occur_move_cbs_psychology_bldg_2)) (considered_occur_move_bank_tav_3) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_angazi_cafe_angazi_cafe_4
     :parameters ()
     :precondition (and (considered_occur_move_bank_tav_3)(occur_move angazi_cafe angazi_cafe))
     :effect (and (not (considered_occur_move_bank_tav_3)) (considered_occur_move_angazi_cafe_angazi_cafe_4) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_cbs_psychology_bldg_2
     :parameters ()
     :precondition (and (considered_occur_move_hayman_theater_cbs_1)(not (occur_move cbs psychology_bldg)))
     :effect (and (not (considered_occur_move_hayman_theater_cbs_1)) (considered_occur_move_cbs_psychology_bldg_2) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_bank_tav_3
     :parameters ()
     :precondition (and (considered_occur_move_cbs_psychology_bldg_2)(not (occur_move bank tav)))
     :effect (and (not (considered_occur_move_cbs_psychology_bldg_2)) (considered_occur_move_bank_tav_3) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_angazi_cafe_angazi_cafe_4
     :parameters ()
     :precondition (and (considered_occur_move_bank_tav_3)(not (occur_move angazi_cafe angazi_cafe)))
     :effect (and (not (considered_occur_move_bank_tav_3)) (considered_occur_move_angazi_cafe_angazi_cafe_4) (increase (total-cost) 2000)))
)
