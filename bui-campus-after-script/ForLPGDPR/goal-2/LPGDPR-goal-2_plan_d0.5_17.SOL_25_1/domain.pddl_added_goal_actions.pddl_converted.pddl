...
(considered_occur_move_bookmark_cafe_bookmark_cafe_3)
...
(:action hidden-explain-obs-occur_move_bookmark_cafe_bookmark_cafe_3
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_jones_theater_2)(occur_move bookmark_cafe bookmark_cafe))
     :effect (and (not (considered_occur_move_davis_theater_jones_theater_2)) (considered_occur_move_bookmark_cafe_bookmark_cafe_3) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_bookmark_cafe_bookmark_cafe_3
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_jones_theater_2)(not (occur_move bookmark_cafe bookmark_cafe)))
     :effect (and (not (considered_occur_move_davis_theater_jones_theater_2)) (considered_occur_move_bookmark_cafe_bookmark_cafe_3) (increase (total-cost) 2000)))
)
