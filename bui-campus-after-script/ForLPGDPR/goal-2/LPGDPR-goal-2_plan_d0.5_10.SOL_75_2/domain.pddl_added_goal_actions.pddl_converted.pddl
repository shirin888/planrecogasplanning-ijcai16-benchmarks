...
(considered_occur_move_library_library_6)
(considered_occur_move_bookmark_cafe_davis_theater_7)
...
(:action hidden-explain-obs-occur_move_library_library_6
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_bookmark_cafe_5)(occur_move library library))
     :effect (and (not (considered_occur_move_jones_theater_bookmark_cafe_5)) (considered_occur_move_library_library_6) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_bookmark_cafe_davis_theater_7
     :parameters ()
     :precondition (and (considered_occur_move_library_library_6)(occur_move bookmark_cafe davis_theater))
     :effect (and (not (considered_occur_move_library_library_6)) (considered_occur_move_bookmark_cafe_davis_theater_7) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_library_library_6
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_bookmark_cafe_5)(not (occur_move library library)))
     :effect (and (not (considered_occur_move_jones_theater_bookmark_cafe_5)) (considered_occur_move_library_library_6) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_bookmark_cafe_davis_theater_7
     :parameters ()
     :precondition (and (considered_occur_move_library_library_6)(not (occur_move bookmark_cafe davis_theater)))
     :effect (and (not (considered_occur_move_library_library_6)) (considered_occur_move_bookmark_cafe_davis_theater_7) (increase (total-cost) 2000)))
)
