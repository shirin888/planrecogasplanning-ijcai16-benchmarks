...
(considered_occur_move_angazi_cafe_jones_theater_1)
...
(:action hidden-explain-obs-occur_move_angazi_cafe_jones_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_0)(occur_move angazi_cafe jones_theater))
     :effect (and (not (considered_occur_move_davis_theater_bank_0)) (considered_occur_move_angazi_cafe_jones_theater_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_bookmark_cafe_bookmark_cafe_2
     :parameters ()
     :precondition (and (considered_occur_move_angazi_cafe_jones_theater_1)(occur_move bookmark_cafe bookmark_cafe))
     :effect (and (not (considered_occur_move_angazi_cafe_jones_theater_1)) (considered_occur_move_bookmark_cafe_bookmark_cafe_2) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_bank_jones_theater_3
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_bookmark_cafe_2)(occur_move bank jones_theater))
     :effect (and (not (considered_occur_move_bookmark_cafe_bookmark_cafe_2)) (considered_occur_move_bank_jones_theater_3) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_angazi_cafe_jones_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_0)(not (occur_move angazi_cafe jones_theater)))
     :effect (and (not (considered_occur_move_davis_theater_bank_0)) (considered_occur_move_angazi_cafe_jones_theater_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_bookmark_cafe_bookmark_cafe_2
     :parameters ()
     :precondition (and (considered_occur_move_angazi_cafe_jones_theater_1)(not (occur_move bookmark_cafe bookmark_cafe)))
     :effect (and (not (considered_occur_move_angazi_cafe_jones_theater_1)) (considered_occur_move_bookmark_cafe_bookmark_cafe_2) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_bank_jones_theater_3
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_bookmark_cafe_2)(not (occur_move bank jones_theater)))
     :effect (and (not (considered_occur_move_bookmark_cafe_bookmark_cafe_2)) (considered_occur_move_bank_jones_theater_3) (increase (total-cost) 2000)))
)
