...
(:action hidden-explain-obs-occur_move_psychology_bldg_watson_theater_5
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_angazi_cafe_4)(occur_move psychology_bldg watson_theater))
     :effect (and (not (considered_occur_move_jones_theater_angazi_cafe_4)) (considered_occur_move_psychology_bldg_watson_theater_5) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_psychology_bldg_watson_theater_5
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_angazi_cafe_4)(not (occur_move psychology_bldg watson_theater)))
     :effect (and (not (considered_occur_move_jones_theater_angazi_cafe_4)) (considered_occur_move_psychology_bldg_watson_theater_5) (increase (total-cost) 2000)))
)
