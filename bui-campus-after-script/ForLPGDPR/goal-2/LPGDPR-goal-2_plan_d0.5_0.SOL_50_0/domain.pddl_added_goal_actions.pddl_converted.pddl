...
(:action hidden-explain-obs-occur_move_jones_theater_psychology_bldg_2
     :parameters ()
     :precondition (and (considered_occur_move_bank_psychology_bldg_1)(occur_move jones_theater psychology_bldg))
     :effect (and (not (considered_occur_move_bank_psychology_bldg_1)) (considered_occur_move_jones_theater_psychology_bldg_2) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_psychology_bldg_bookmark_cafe_3
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_psychology_bldg_2)(occur_move psychology_bldg bookmark_cafe))
     :effect (and (not (considered_occur_move_jones_theater_psychology_bldg_2)) (considered_occur_move_psychology_bldg_bookmark_cafe_3) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_jones_theater_psychology_bldg_2
     :parameters ()
     :precondition (and (considered_occur_move_bank_psychology_bldg_1)(not (occur_move jones_theater psychology_bldg)))
     :effect (and (not (considered_occur_move_bank_psychology_bldg_1)) (considered_occur_move_jones_theater_psychology_bldg_2) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_psychology_bldg_bookmark_cafe_3
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_psychology_bldg_2)(not (occur_move psychology_bldg bookmark_cafe)))
     :effect (and (not (considered_occur_move_jones_theater_psychology_bldg_2)) (considered_occur_move_psychology_bldg_bookmark_cafe_3) (increase (total-cost) 2000)))
)
