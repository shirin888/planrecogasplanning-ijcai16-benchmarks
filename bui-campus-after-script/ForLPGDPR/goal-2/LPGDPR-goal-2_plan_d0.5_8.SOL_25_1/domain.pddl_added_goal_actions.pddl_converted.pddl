...
(:action hidden-explain-obs-occur_move_psychology_bldg_tav_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_cbs_0)(occur_move psychology_bldg tav))
     :effect (and (not (considered_occur_move_davis_theater_cbs_0)) (considered_occur_move_psychology_bldg_tav_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_cbs_davis_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_psychology_bldg_tav_1)(occur_move cbs davis_theater))
     :effect (and (not (considered_occur_move_psychology_bldg_tav_1)) (considered_occur_move_cbs_davis_theater_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_psychology_bldg_tav_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_cbs_0)(not (occur_move psychology_bldg tav)))
     :effect (and (not (considered_occur_move_davis_theater_cbs_0)) (considered_occur_move_psychology_bldg_tav_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_cbs_davis_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_psychology_bldg_tav_1)(not (occur_move cbs davis_theater)))
     :effect (and (not (considered_occur_move_psychology_bldg_tav_1)) (considered_occur_move_cbs_davis_theater_2) (increase (total-cost) 2000)))
)
