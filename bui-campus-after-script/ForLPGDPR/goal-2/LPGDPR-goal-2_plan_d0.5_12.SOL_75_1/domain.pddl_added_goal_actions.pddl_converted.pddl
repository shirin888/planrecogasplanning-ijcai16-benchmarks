...
(:action hidden-explain-obs-occur_move_psychology_bldg_bank_5
     :parameters ()
     :precondition (and (considered_occur_move_tav_jones_theater_4)(occur_move psychology_bldg bank))
     :effect (and (not (considered_occur_move_tav_jones_theater_4)) (considered_occur_move_psychology_bldg_bank_5) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_psychology_bldg_bank_5
     :parameters ()
     :precondition (and (considered_occur_move_tav_jones_theater_4)(not (occur_move psychology_bldg bank)))
     :effect (and (not (considered_occur_move_tav_jones_theater_4)) (considered_occur_move_psychology_bldg_bank_5) (increase (total-cost) 2000)))
)
