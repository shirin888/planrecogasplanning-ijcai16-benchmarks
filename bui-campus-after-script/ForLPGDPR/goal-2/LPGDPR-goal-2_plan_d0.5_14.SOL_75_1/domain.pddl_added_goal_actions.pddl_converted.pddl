...
(considered_occur_move_cbs_watson_theater_6)
...
(:action hidden-explain-obs-occur_move_davis_theater_bookmark_cafe_3
     :parameters ()
     :precondition (and (considered_occur_move_psychology_bldg_jones_theater_2)(occur_move davis_theater bookmark_cafe))
     :effect (and (not (considered_occur_move_psychology_bldg_jones_theater_2)) (considered_occur_move_davis_theater_bookmark_cafe_3) (increase (total-cost) 1)))  
...
(:action hidden-explain-obs-occur_move_cbs_watson_theater_6
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_psychology_bldg_5)(occur_move cbs watson_theater))
     :effect (and (not (considered_occur_move_jones_theater_psychology_bldg_5)) (considered_occur_move_cbs_watson_theater_6) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_davis_theater_bookmark_cafe_3
     :parameters ()
     :precondition (and (considered_occur_move_psychology_bldg_jones_theater_2)(not (occur_move davis_theater bookmark_cafe)))
     :effect (and (not (considered_occur_move_psychology_bldg_jones_theater_2)) (considered_occur_move_davis_theater_bookmark_cafe_3) (increase (total-cost) 2000)))
...
(:action hidden-discard-obs-occur_move_cbs_watson_theater_6
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_psychology_bldg_5)(not (occur_move cbs watson_theater)))
     :effect (and (not (considered_occur_move_jones_theater_psychology_bldg_5)) (considered_occur_move_cbs_watson_theater_6) (increase (total-cost) 2000)))
)
