...
(:action hidden-explain-obs-occur_move_bank_angazi_cafe_4
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_tav_3)(occur_move bank angazi_cafe))
     :effect (and (not (considered_occur_move_jones_theater_tav_3)) (considered_occur_move_bank_angazi_cafe_4) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_bank_angazi_cafe_4
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_tav_3)(not (occur_move bank angazi_cafe)))
     :effect (and (not (considered_occur_move_jones_theater_tav_3)) (considered_occur_move_bank_angazi_cafe_4) (increase (total-cost) 2000)))
)
