...
(considered_occur_move_angazi_cafe_angazi_cafe_6)
...
(:action hidden-explain-obs-occur_move_angazi_cafe_angazi_cafe_6
     :parameters ()
     :precondition (and (considered_occur_move_angazi_cafe_bookmark_cafe_5)(occur_move angazi_cafe angazi_cafe))
     :effect (and (not (considered_occur_move_angazi_cafe_bookmark_cafe_5)) (considered_occur_move_angazi_cafe_angazi_cafe_6) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_angazi_cafe_angazi_cafe_6
     :parameters ()
     :precondition (and (considered_occur_move_angazi_cafe_bookmark_cafe_5)(not (occur_move angazi_cafe angazi_cafe)))
     :effect (and (not (considered_occur_move_angazi_cafe_bookmark_cafe_5)) (considered_occur_move_angazi_cafe_angazi_cafe_6) (increase (total-cost) 2000)))
)
