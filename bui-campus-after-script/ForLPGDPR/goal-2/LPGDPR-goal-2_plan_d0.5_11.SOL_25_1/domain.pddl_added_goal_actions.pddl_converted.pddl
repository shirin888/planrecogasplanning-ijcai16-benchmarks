...
(:action hidden-explain-obs-occur_move_bookmark_cafe_bookmark_cafe_2
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_davis_theater_1)(occur_move bookmark_cafe bookmark_cafe))
     :effect (and (not (considered_occur_move_bookmark_cafe_davis_theater_1)) (considered_occur_move_bookmark_cafe_bookmark_cafe_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_bookmark_cafe_bookmark_cafe_2
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_davis_theater_1)(not (occur_move bookmark_cafe bookmark_cafe)))
     :effect (and (not (considered_occur_move_bookmark_cafe_davis_theater_1)) (considered_occur_move_bookmark_cafe_bookmark_cafe_2) (increase (total-cost) 2000)))
)
