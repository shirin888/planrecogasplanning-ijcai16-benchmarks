...
(:predicates (considered_occur_init)(considered_occur_move_jones_theater_hayman_theater_0)
...
(:action hidden-explain-obs-occur_move_jones_theater_hayman_theater_0
     :parameters ()
     :precondition (and  (considered_occur_init) (occur_move jones_theater hayman_theater))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_jones_theater_hayman_theater_0) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_hayman_theater_psychology_bldg_1
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_hayman_theater_0)(occur_move hayman_theater psychology_bldg))
     :effect (and (not (considered_occur_move_jones_theater_hayman_theater_0)) (considered_occur_move_hayman_theater_psychology_bldg_1) (increase (total-cost) 1)))  



(:action hidden-discard-obs-occur_move_jones_theater_hayman_theater_0
     :parameters ()
     :precondition (and  (considered_occur_init) (not (occur_move jones_theater hayman_theater)))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_jones_theater_hayman_theater_0) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_hayman_theater_psychology_bldg_1
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_hayman_theater_0)(not (occur_move hayman_theater psychology_bldg)))
     :effect (and (not (considered_occur_move_jones_theater_hayman_theater_0)) (considered_occur_move_hayman_theater_psychology_bldg_1) (increase (total-cost) 2000)))
)
