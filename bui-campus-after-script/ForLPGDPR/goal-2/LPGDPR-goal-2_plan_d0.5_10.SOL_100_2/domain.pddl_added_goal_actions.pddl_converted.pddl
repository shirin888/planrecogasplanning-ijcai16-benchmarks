...
(:action hidden-explain-obs-occur_move_watson_theater_cbs_7
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_psychology_bldg_6)(occur_move watson_theater cbs))
     :effect (and (not (considered_occur_move_bookmark_cafe_psychology_bldg_6)) (considered_occur_move_watson_theater_cbs_7) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_watson_theater_psychology_bldg_8
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_cbs_7)(occur_move watson_theater psychology_bldg))
     :effect (and (not (considered_occur_move_watson_theater_cbs_7)) (considered_occur_move_watson_theater_psychology_bldg_8) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_watson_theater_cbs_7
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_psychology_bldg_6)(not (occur_move watson_theater cbs)))
     :effect (and (not (considered_occur_move_bookmark_cafe_psychology_bldg_6)) (considered_occur_move_watson_theater_cbs_7) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_watson_theater_psychology_bldg_8
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_cbs_7)(not (occur_move watson_theater psychology_bldg)))
     :effect (and (not (considered_occur_move_watson_theater_cbs_7)) (considered_occur_move_watson_theater_psychology_bldg_8) (increase (total-cost) 2000)))
)
