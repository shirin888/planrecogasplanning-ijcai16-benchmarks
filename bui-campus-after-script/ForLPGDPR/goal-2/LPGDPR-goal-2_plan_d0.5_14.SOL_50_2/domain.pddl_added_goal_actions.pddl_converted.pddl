...
(considered_occur_move_psychology_bldg_angazi_cafe_5)
...
(:action hidden-explain-obs-occur_move_bookmark_cafe_jones_theater_3
     :parameters ()
     :precondition (and (considered_occur_move_psychology_bldg_jones_theater_2)(occur_move bookmark_cafe jones_theater))
     :effect (and (not (considered_occur_move_psychology_bldg_jones_theater_2)) (considered_occur_move_bookmark_cafe_jones_theater_3) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_watson_theater_psychology_bldg_4
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_jones_theater_3)(occur_move watson_theater psychology_bldg))
     :effect (and (not (considered_occur_move_bookmark_cafe_jones_theater_3)) (considered_occur_move_watson_theater_psychology_bldg_4) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_psychology_bldg_angazi_cafe_5
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_psychology_bldg_4)(occur_move psychology_bldg angazi_cafe))
     :effect (and (not (considered_occur_move_watson_theater_psychology_bldg_4)) (considered_occur_move_psychology_bldg_angazi_cafe_5) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_bookmark_cafe_jones_theater_3
     :parameters ()
     :precondition (and (considered_occur_move_psychology_bldg_jones_theater_2)(not (occur_move bookmark_cafe jones_theater)))
     :effect (and (not (considered_occur_move_psychology_bldg_jones_theater_2)) (considered_occur_move_bookmark_cafe_jones_theater_3) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_watson_theater_psychology_bldg_4
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_jones_theater_3)(not (occur_move watson_theater psychology_bldg)))
     :effect (and (not (considered_occur_move_bookmark_cafe_jones_theater_3)) (considered_occur_move_watson_theater_psychology_bldg_4) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_psychology_bldg_angazi_cafe_5
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_psychology_bldg_4)(not (occur_move psychology_bldg angazi_cafe)))
     :effect (and (not (considered_occur_move_watson_theater_psychology_bldg_4)) (considered_occur_move_psychology_bldg_angazi_cafe_5) (increase (total-cost) 2000)))
)
