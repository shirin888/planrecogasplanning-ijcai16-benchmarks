...
(:predicates (considered_occur_init)(considered_occur_move_tav_jones_theater_0)
...
(:action hidden-explain-obs-occur_move_tav_jones_theater_0
     :parameters ()
     :precondition (and  (considered_occur_init) (occur_move tav jones_theater))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_tav_jones_theater_0) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_jones_theater_psychology_bldg_1
     :parameters ()
     :precondition (and (considered_occur_move_tav_jones_theater_0)(occur_move jones_theater psychology_bldg))
     :effect (and (not (considered_occur_move_tav_jones_theater_0)) (considered_occur_move_jones_theater_psychology_bldg_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_library_psychology_bldg_2
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_psychology_bldg_1)(occur_move library psychology_bldg))
     :effect (and (not (considered_occur_move_jones_theater_psychology_bldg_1)) (considered_occur_move_library_psychology_bldg_2) (increase (total-cost) 1)))  



(:action hidden-discard-obs-occur_move_tav_jones_theater_0
     :parameters ()
     :precondition (and  (considered_occur_init) (not (occur_move tav jones_theater)))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_tav_jones_theater_0) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_jones_theater_psychology_bldg_1
     :parameters ()
     :precondition (and (considered_occur_move_tav_jones_theater_0)(not (occur_move jones_theater psychology_bldg)))
     :effect (and (not (considered_occur_move_tav_jones_theater_0)) (considered_occur_move_jones_theater_psychology_bldg_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_library_psychology_bldg_2
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_psychology_bldg_1)(not (occur_move library psychology_bldg)))
     :effect (and (not (considered_occur_move_jones_theater_psychology_bldg_1)) (considered_occur_move_library_psychology_bldg_2) (increase (total-cost) 2000)))
)
