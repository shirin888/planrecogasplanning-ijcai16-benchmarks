...
(:action hidden-explain-obs-occur_move_psychology_bldg_hayman_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_bank_psychology_bldg_1)(occur_move psychology_bldg hayman_theater))
     :effect (and (not (considered_occur_move_bank_psychology_bldg_1)) (considered_occur_move_psychology_bldg_hayman_theater_2) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_bank_cbs_3
     :parameters ()
     :precondition (and (considered_occur_move_psychology_bldg_hayman_theater_2)(occur_move bank cbs))
     :effect (and (not (considered_occur_move_psychology_bldg_hayman_theater_2)) (considered_occur_move_bank_cbs_3) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_psychology_bldg_hayman_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_bank_psychology_bldg_1)(not (occur_move psychology_bldg hayman_theater)))
     :effect (and (not (considered_occur_move_bank_psychology_bldg_1)) (considered_occur_move_psychology_bldg_hayman_theater_2) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_bank_cbs_3
     :parameters ()
     :precondition (and (considered_occur_move_psychology_bldg_hayman_theater_2)(not (occur_move bank cbs)))
     :effect (and (not (considered_occur_move_psychology_bldg_hayman_theater_2)) (considered_occur_move_bank_cbs_3) (increase (total-cost) 2000)))
)
