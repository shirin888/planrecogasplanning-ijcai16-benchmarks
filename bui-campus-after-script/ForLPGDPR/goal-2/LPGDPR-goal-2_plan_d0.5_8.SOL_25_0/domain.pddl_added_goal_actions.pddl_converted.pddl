...
(:predicates (considered_occur_init)(considered_occur_move_cbs_bank_0)
...
(:action hidden-explain-obs-occur_move_cbs_bank_0
     :parameters ()
     :precondition (and  (considered_occur_init) (occur_move cbs bank))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_cbs_bank_0) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_bank_davis_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_cbs_bank_0)(occur_move bank davis_theater))
     :effect (and (not (considered_occur_move_cbs_bank_0)) (considered_occur_move_bank_davis_theater_1) (increase (total-cost) 1)))  



(:action hidden-discard-obs-occur_move_cbs_bank_0
     :parameters ()
     :precondition (and  (considered_occur_init) (not (occur_move cbs bank)))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_cbs_bank_0) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_bank_davis_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_cbs_bank_0)(not (occur_move bank davis_theater)))
     :effect (and (not (considered_occur_move_cbs_bank_0)) (considered_occur_move_bank_davis_theater_1) (increase (total-cost) 2000)))
)
