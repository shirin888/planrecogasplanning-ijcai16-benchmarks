...
(considered_occur_move_jones_theater_tav_2)
...
(:action hidden-explain-obs-occur_move_jones_theater_tav_2
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_jones_theater_1)(occur_move jones_theater tav))
     :effect (and (not (considered_occur_move_bookmark_cafe_jones_theater_1)) (considered_occur_move_jones_theater_tav_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_jones_theater_tav_2
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_jones_theater_1)(not (occur_move jones_theater tav)))
     :effect (and (not (considered_occur_move_bookmark_cafe_jones_theater_1)) (considered_occur_move_jones_theater_tav_2) (increase (total-cost) 2000)))
)
