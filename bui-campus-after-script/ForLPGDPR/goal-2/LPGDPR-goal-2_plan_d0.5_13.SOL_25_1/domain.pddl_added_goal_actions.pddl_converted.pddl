...
(:action hidden-explain-obs-occur_move_cbs_hayman_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_bank_davis_theater_1)(occur_move cbs hayman_theater))
     :effect (and (not (considered_occur_move_bank_davis_theater_1)) (considered_occur_move_cbs_hayman_theater_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_cbs_hayman_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_bank_davis_theater_1)(not (occur_move cbs hayman_theater)))
     :effect (and (not (considered_occur_move_bank_davis_theater_1)) (considered_occur_move_cbs_hayman_theater_2) (increase (total-cost) 2000)))
)
