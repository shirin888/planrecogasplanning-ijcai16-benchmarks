...
(:action hidden-explain-obs-occur_move_tav_jones_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_0)(occur_move tav jones_theater))
     :effect (and (not (considered_occur_move_davis_theater_bank_0)) (considered_occur_move_tav_jones_theater_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_jones_theater_psychology_bldg_2
     :parameters ()
     :precondition (and (considered_occur_move_tav_jones_theater_1)(occur_move jones_theater psychology_bldg))
     :effect (and (not (considered_occur_move_tav_jones_theater_1)) (considered_occur_move_jones_theater_psychology_bldg_2) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_tav_tav_3
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_psychology_bldg_2)(occur_move tav tav))
     :effect (and (not (considered_occur_move_jones_theater_psychology_bldg_2)) (considered_occur_move_tav_tav_3) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_tav_jones_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_0)(not (occur_move tav jones_theater)))
     :effect (and (not (considered_occur_move_davis_theater_bank_0)) (considered_occur_move_tav_jones_theater_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_jones_theater_psychology_bldg_2
     :parameters ()
     :precondition (and (considered_occur_move_tav_jones_theater_1)(not (occur_move jones_theater psychology_bldg)))
     :effect (and (not (considered_occur_move_tav_jones_theater_1)) (considered_occur_move_jones_theater_psychology_bldg_2) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_tav_tav_3
     :parameters ()
     :precondition (and (considered_occur_move_jones_theater_psychology_bldg_2)(not (occur_move tav tav)))
     :effect (and (not (considered_occur_move_jones_theater_psychology_bldg_2)) (considered_occur_move_tav_tav_3) (increase (total-cost) 2000)))
)
