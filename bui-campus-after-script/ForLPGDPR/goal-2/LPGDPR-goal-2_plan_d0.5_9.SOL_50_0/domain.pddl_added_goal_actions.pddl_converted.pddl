...
(:predicates (considered_occur_init)(considered_occur_move_tav_bank_0)
...
(:action hidden-explain-obs-occur_move_tav_bank_0
     :parameters ()
     :precondition (and  (considered_occur_init) (occur_move tav bank))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_tav_bank_0) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_cbs_psychology_bldg_1
     :parameters ()
     :precondition (and (considered_occur_move_tav_bank_0)(occur_move cbs psychology_bldg))
     :effect (and (not (considered_occur_move_tav_bank_0)) (considered_occur_move_cbs_psychology_bldg_1) (increase (total-cost) 1)))  
...
(:action hidden-explain-obs-occur_move_jones_theater_psychology_bldg_3
     :parameters ()
     :precondition (and (considered_occur_move_psychology_bldg_davis_theater_2)(occur_move jones_theater psychology_bldg))
     :effect (and (not (considered_occur_move_psychology_bldg_davis_theater_2)) (considered_occur_move_jones_theater_psychology_bldg_3) (increase (total-cost) 1)))  



(:action hidden-discard-obs-occur_move_tav_bank_0
     :parameters ()
     :precondition (and  (considered_occur_init) (not (occur_move tav bank)))
     :effect (and (not  (considered_occur_init)) (considered_occur_move_tav_bank_0) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_cbs_psychology_bldg_1
     :parameters ()
     :precondition (and (considered_occur_move_tav_bank_0)(not (occur_move cbs psychology_bldg)))
     :effect (and (not (considered_occur_move_tav_bank_0)) (considered_occur_move_cbs_psychology_bldg_1) (increase (total-cost) 2000)))
...
(:action hidden-discard-obs-occur_move_jones_theater_psychology_bldg_3
     :parameters ()
     :precondition (and (considered_occur_move_psychology_bldg_davis_theater_2)(not (occur_move jones_theater psychology_bldg)))
     :effect (and (not (considered_occur_move_psychology_bldg_davis_theater_2)) (considered_occur_move_jones_theater_psychology_bldg_3) (increase (total-cost) 2000)))
)
