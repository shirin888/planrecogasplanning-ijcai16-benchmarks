...
(considered_occur_move_cbs_jones_theater_1)
(considered_occur_move_bank_hayman_theater_2)
...
(:action hidden-explain-obs-occur_move_cbs_jones_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_cbs_0)(occur_move cbs jones_theater))
     :effect (and (not (considered_occur_move_davis_theater_cbs_0)) (considered_occur_move_cbs_jones_theater_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_bank_hayman_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_cbs_jones_theater_1)(occur_move bank hayman_theater))
     :effect (and (not (considered_occur_move_cbs_jones_theater_1)) (considered_occur_move_bank_hayman_theater_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_cbs_jones_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_cbs_0)(not (occur_move cbs jones_theater)))
     :effect (and (not (considered_occur_move_davis_theater_cbs_0)) (considered_occur_move_cbs_jones_theater_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_bank_hayman_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_cbs_jones_theater_1)(not (occur_move bank hayman_theater)))
     :effect (and (not (considered_occur_move_cbs_jones_theater_1)) (considered_occur_move_bank_hayman_theater_2) (increase (total-cost) 2000)))
)
