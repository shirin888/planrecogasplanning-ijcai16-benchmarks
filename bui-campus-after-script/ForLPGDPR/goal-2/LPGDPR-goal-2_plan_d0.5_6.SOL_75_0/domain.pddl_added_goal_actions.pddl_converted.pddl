...
(:action hidden-explain-obs-occur_move_jones_theater_angazi_cafe_3
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_jones_theater_2)(occur_move jones_theater angazi_cafe))
     :effect (and (not (considered_occur_move_davis_theater_jones_theater_2)) (considered_occur_move_jones_theater_angazi_cafe_3) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_jones_theater_angazi_cafe_3
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_jones_theater_2)(not (occur_move jones_theater angazi_cafe)))
     :effect (and (not (considered_occur_move_davis_theater_jones_theater_2)) (considered_occur_move_jones_theater_angazi_cafe_3) (increase (total-cost) 2000)))
