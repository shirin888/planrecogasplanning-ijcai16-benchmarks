...
(considered_occur_move_tav_jones_theater_2)
...
(:action hidden-explain-obs-occur_move_tav_jones_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_bank_cbs_1)(occur_move tav jones_theater))
     :effect (and (not (considered_occur_move_bank_cbs_1)) (considered_occur_move_tav_jones_theater_2) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_bookmark_cafe_library_3
     :parameters ()
     :precondition (and (considered_occur_move_tav_jones_theater_2)(occur_move bookmark_cafe library))
     :effect (and (not (considered_occur_move_tav_jones_theater_2)) (considered_occur_move_bookmark_cafe_library_3) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_psychology_bldg_watson_theater_4
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_library_3)(occur_move psychology_bldg watson_theater))
     :effect (and (not (considered_occur_move_bookmark_cafe_library_3)) (considered_occur_move_psychology_bldg_watson_theater_4) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_tav_jones_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_bank_cbs_1)(not (occur_move tav jones_theater)))
     :effect (and (not (considered_occur_move_bank_cbs_1)) (considered_occur_move_tav_jones_theater_2) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_bookmark_cafe_library_3
     :parameters ()
     :precondition (and (considered_occur_move_tav_jones_theater_2)(not (occur_move bookmark_cafe library)))
     :effect (and (not (considered_occur_move_tav_jones_theater_2)) (considered_occur_move_bookmark_cafe_library_3) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_psychology_bldg_watson_theater_4
     :parameters ()
     :precondition (and (considered_occur_move_bookmark_cafe_library_3)(not (occur_move psychology_bldg watson_theater)))
     :effect (and (not (considered_occur_move_bookmark_cafe_library_3)) (considered_occur_move_psychology_bldg_watson_theater_4) (increase (total-cost) 2000)))
)
