...
(:action hidden-explain-obs-occur_move_davis_theater_tav_1
     :parameters ()
     :precondition (and (considered_occur_move_cbs_davis_theater_0)(occur_move davis_theater tav))
     :effect (and (not (considered_occur_move_cbs_davis_theater_0)) (considered_occur_move_davis_theater_tav_1) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_davis_theater_tav_1
     :parameters ()
     :precondition (and (considered_occur_move_cbs_davis_theater_0)(not (occur_move davis_theater tav)))
     :effect (and (not (considered_occur_move_cbs_davis_theater_0)) (considered_occur_move_davis_theater_tav_1) (increase (total-cost) 2000)))
)
