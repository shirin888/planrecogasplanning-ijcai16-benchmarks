...
(:action hidden-explain-obs-occur_move_jones_theater_bookmark_cafe_4
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_watson_theater_3)(occur_move jones_theater bookmark_cafe))
     :effect (and (not (considered_occur_move_davis_theater_watson_theater_3)) (considered_occur_move_jones_theater_bookmark_cafe_4) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_jones_theater_bookmark_cafe_4
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_watson_theater_3)(not (occur_move jones_theater bookmark_cafe)))
     :effect (and (not (considered_occur_move_davis_theater_watson_theater_3)) (considered_occur_move_jones_theater_bookmark_cafe_4) (increase (total-cost) 2000)))
