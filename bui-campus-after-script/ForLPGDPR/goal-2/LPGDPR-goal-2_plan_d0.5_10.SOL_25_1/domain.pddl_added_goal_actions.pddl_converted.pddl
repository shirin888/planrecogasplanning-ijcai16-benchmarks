...
(considered_occur_move_watson_theater_jones_theater_1)
...
(:action hidden-explain-obs-occur_move_watson_theater_jones_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_0)(occur_move watson_theater jones_theater))
     :effect (and (not (considered_occur_move_davis_theater_bank_0)) (considered_occur_move_watson_theater_jones_theater_1) (increase (total-cost) 1)))  

(:action hidden-explain-obs-occur_move_tav_watson_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_jones_theater_1)(occur_move tav watson_theater))
     :effect (and (not (considered_occur_move_watson_theater_jones_theater_1)) (considered_occur_move_tav_watson_theater_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_watson_theater_jones_theater_1
     :parameters ()
     :precondition (and (considered_occur_move_davis_theater_bank_0)(not (occur_move watson_theater jones_theater)))
     :effect (and (not (considered_occur_move_davis_theater_bank_0)) (considered_occur_move_watson_theater_jones_theater_1) (increase (total-cost) 2000)))

(:action hidden-discard-obs-occur_move_tav_watson_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_watson_theater_jones_theater_1)(not (occur_move tav watson_theater)))
     :effect (and (not (considered_occur_move_watson_theater_jones_theater_1)) (considered_occur_move_tav_watson_theater_2) (increase (total-cost) 2000)))
)
