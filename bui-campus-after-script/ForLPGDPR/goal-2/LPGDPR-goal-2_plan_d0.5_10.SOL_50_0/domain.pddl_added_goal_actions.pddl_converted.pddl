...
(:action hidden-explain-obs-occur_move_watson_theater_jones_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_bank_psychology_bldg_1)(occur_move watson_theater jones_theater))
     :effect (and (not (considered_occur_move_bank_psychology_bldg_1)) (considered_occur_move_watson_theater_jones_theater_2) (increase (total-cost) 1)))  
...
(:action hidden-discard-obs-occur_move_watson_theater_jones_theater_2
     :parameters ()
     :precondition (and (considered_occur_move_bank_psychology_bldg_1)(not (occur_move watson_theater jones_theater)))
     :effect (and (not (considered_occur_move_bank_psychology_bldg_1)) (considered_occur_move_watson_theater_jones_theater_2) (increase (total-cost) 2000)))
